        ...
        <div className="p-6 md:p-8 max-w-[1400px] mx-auto min-h-full flex flex-col gap-8">
            ...
            {activeSyllabus ? (
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 w-full">
                        <div className="space-y-3 max-w-xl">
                            ...
                            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#2C3039] leading-tight">
                                ...
                                <span className="text-[#C0392B] font-bold drop-shadow-2xs">
                        ...
                        <div className="group shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-5 border border-[#980811] flex flex-col justify-center min-w-[320px] sm:min-w-[380px] shadow-sm hover:border-[#980811] hover:-translate-y-0.5 transition-all duration-300">
                            ...
                            <div className="text-3xl font-bold text-[#2C3039] my-1 flex items-baseline justify-between gap-6">
                                <div>
                                    <span className="text-[#C0392B]">{progressPct}%</span>
                            ...
                            <p className="text-xs font-semibold text-[#C0392B] mt-3 flex items-center justify-between gap-4">
                                ...
                                <span className="text-[#C0392B] font-bold hover:underline cursor-pointer">Tiếp tục </span>
                            </p>
                        </div>
                    </div>
                </section>
                ...
                <section className="relative overflow-hidden rounded-2xl bg-[#F8F9FE] border border-[#E8EAF4] p-6 text-center shadow-sm">
                    <h2 className="text-lg font-semibold text-[#2C3039] mb-2">Chưa có Lộ trình học</h2>
                    <p className="text-[#8A8478] text-sm mb-4">Bạn cần đăng ký khóa học để hệ thống tạo Lộ trình AI cá nhân hóa.</p>
                    <a href="/explore" className="inline-flex items-center gap-2 px-4 py-2 bg-[#C0392B] text-white rounded-xl font-medium text-sm transition-colors hover:bg-[#3234a8]">
                        Khám phá Khóa học
                    </a>
                </section>
            )}
