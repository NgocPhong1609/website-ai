...
export default async function AIStudyPlanPage() {
 ...
 <div className="group shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-5 border border-[#E8E2D9] flex flex-col justify-center min-w-[320px] sm:min-w-[380px] shadow-sm hover:border-[#E8E2D9] hover:-translate-y-0.5 transition-all duration-300">
