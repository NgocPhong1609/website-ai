...
export default async function DashboardPage() {
    ...
    return (
        <div className="flex flex-col gap-8 p-6 md:p-8 max-w-[1400px] w-full mx-auto min-h-[calc(100vh-4rem)]">
            ...
            <section className="relative overflow-hidden rounded-2xl bg-[#FEFCF9] border border-[#980811] p-6 sm:p-7 shadow-[0_8px_30px_rgba(107,107,255,0.07)] transition-all duration-300 hover:shadow-[0_12px_36px_rgba(107,107,255,0.12)] w-full">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 w-full">
                    <div className="space-y-3 max-w-xl">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/95 backdrop-blur-md border border-[#980811] text-xs font-semibold text-[#C0392B] shadow-sm">
                    ...
                    {dashboardData.user ? (
                        <Link href="/study-plan" className="group block shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-5 border border-[#980811] flex flex-col justify-center min-w-[320px] sm:min-w-[380px] shadow-sm hover:border-[#980811] hover:-translate-y-0.5 transition-all duration-300 text-decoration-none focus:outline-none">
                            ...
                            <div className="w-full h-2 bg-[#F5F0E8] rounded-full mt-2 overflow-hidden p-0.5 border border-[#980811]">
                                <div
                        ...
                        <div className="group block shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-5 border border-[#980811] flex flex-col justify-center min-w-[320px] sm:min-w-[380px] shadow-sm text-center">
            ...
            {dashboardData.user ? (
                ...
                <div className="flex flex-col items-center justify-center py-20 px-4 text-center border border-dashed border-[#980811] rounded-2xl bg-[#FEFCF9]">
