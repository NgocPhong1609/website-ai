...
export default function InstructorQuizListPage() {
 ...
 {toastMessage && (
 <div className="p-4 rounded-2xl bg-emerald-50 border -[#FAF7F2] -[#2C3039] text-xs font-bold flex items-center justify-between shadow-sm animate-fadeIn">
 ...
 className="-[#2C3039] hover:-[#2C3039] font-black cursor-pointer"
 >
 ...
 {/* Top Banner */}
 <div className="p-8 rounded-3xl from-[#1E233E] via-[#2B2D62] to-[#121626] text-white flex flex-col md:flex-row md:items-center justify-between gap-6 shadow-xl border border-white/10">
 <div className="flex flex-col gap-2">
 <div className="flex items-center gap-3">
 <span className="w-12 h-12 rounded-2xl bg-[#C0392B] to-[#F368E0] flex items-center justify-center text-2xl font-black shadow-md">
 🪄
 </span>
 <div>
 <h1 className="text-2xl font-black text-white">AI Quiz Generator Module</h1>
 <p className="text-xs -[#FAF7F2] font-semibold mt-0.5">
 ...
 className="px-6 py-3.5 bg-[#C0392B] hover:from-[#4338CA] hover:to-[#6D28D9] text-white font-black text-xs rounded-2xl shadow-xl hover:scale-105 transition-all text-center flex items-center justify-center gap-2"
 >
 ...
 <div
 key={q.id}
 className="p-6 rounded-2xl bg-white border border-[#EAEAF4] hover:-[#C0392B] shadow-xs hover:shadow-md transition-all flex flex-col justify-between gap-4"
 >
 <div className="flex flex-col gap-3">
 <div className="flex items-center justify-between gap-2 flex-wrap">
 <span className="text-[11px] font-black uppercase px-2.5 py-1 rounded-lg bg-indigo-50 text-[#C0392B] border -[#FAF7F2]">
 ...
 {attachedTitle ? (
 <span
 className="text-[11px] font-bold px-2.5 py-1 rounded-lg bg-emerald-50 -[#2C3039] border -[#FAF7F2] flex items-center gap-1.5 line-clamp-1 max-w-[220px]"
 ...
 className="px-3 py-1.5 bg-indigo-50 hover:-[#FAF7F2] text-[#C0392B] text-[11px] font-extrabold rounded-xl transition-all flex items-center gap-1 border -[#FAF7F2]"
 >
 <span></span>
 <span>Xem đề</span>
 </Link>
 ...
 <span className="font-bold -[#C0392B]">Đề: {quizToDelete.title}</span>
