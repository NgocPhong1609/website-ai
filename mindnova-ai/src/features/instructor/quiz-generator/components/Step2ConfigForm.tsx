      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col gap-4">
          {!embeddedMode && config.source_type === "course" && config.course_title && (
            <div className="p-3.5 rounded-xl bg-red-50 border border-red-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
              ...
              <span className="px-2.5 py-1 bg-white text-[#C0392B] text-[11px] font-extrabold rounded-lg border border-red-100 shadow-2xs">
                Tự động từ Bước 1
              </span>
            </div>
          )}
              ...
              {[
                ...
                <button
                  ...
                  className={`p-2.5 rounded-xl border text-xs font-extrabold flex flex-col items-center gap-1 transition-all ${config.difficulty === diff.key
                    ? "border-[#C0392B] bg-red-50 text-[#C0392B] shadow-xs"
        ...
        <div className="p-6 rounded-3xl bg-red-50/40 border border-red-100 text-[#2C3039] flex flex-col justify-between shadow-xs">
          <div className="flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <span className="px-3 py-1 rounded-xl bg-white text-[#C0392B] text-xs font-mono font-black border border-red-100 shadow-2xs">
                Tổng: {total} câu
              </span>
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="w-full accent-[#C0392B] cursor-pointer h-2 bg-red-100 rounded-lg"
              />
            </div>

            {/* MCQ & Essay Inputs */}
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div className="p-3.5 rounded-2xl bg-white border border-red-100 shadow-2xs flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full p-2.5 rounded-xl bg-red-50/20 border border-red-100 text-[#2C3039] font-black text-sm focus:outline-none focus:border-[#C0392B] focus:bg-white"
                />
              </div>
            ...
            <div className="mt-2 flex flex-col gap-2">
              <div className="flex justify-between text-[11px] font-black">
                <span className="text-[#C0392B]">Trắc nghiệm: {mc} ({mcPercent}%)</span>
                <span className="text-purple-700">Tự luận: {essay} ({essayPercent}%)</span>
              </div>
              <div className="w-full h-3 rounded-full bg-red-100 overflow-hidden flex border border-red-200">
                <div
