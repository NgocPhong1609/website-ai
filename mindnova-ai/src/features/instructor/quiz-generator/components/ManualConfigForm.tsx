  ...
  return (
    <div className="p-8 bg-white rounded-3xl border border-[#E2E8F0] shadow-sm flex flex-col gap-6 animate-fadeIn">
      ...
      <div className="flex items-start gap-4 border-b border-gray-100 pb-5">
        <div className="w-12 h-12 rounded-2xl bg-blue-50 flex items-center justify-center text-2xl font-black text-[#3B82F6] border border-blue-100">
          ⚙️
        </div>
        <div className="flex flex-col gap-1">
          <span className="text-xs font-black text-[#3B82F6] tracking-wider uppercase">Cấu hình thông số</span>
          <h2 className="text-xl font-black text-[#0F172A]">Thông Tin Bài Kiểm Tra Thủ Công</h2>
          <p className="text-xs text-[#64748B] font-medium mt-1 max-w-2xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <div className="p-5 rounded-2xl bg-[#FAF8FF] border border-blue-50 flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  {isLoadingCourses ? (
                    ...
                    <select
                      ...
                      className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm font-bold text-[#0F172A] focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6] transition-all bg-white"
                    >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  rows={2}
                  className="w-full px-4 py-2.5 rounded-xl border border-gray-200 text-sm font-medium text-[#0F172A] focus:outline-none focus:border-[#3B82F6] focus:ring-1 focus:ring-[#3B82F6] transition-all bg-white resize-none"
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full pl-4 pr-10 py-2.5 rounded-xl border border-gray-200 text-sm font-black text-[#0F172A] focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-all bg-white"
                    />
      ...
      <div className="flex items-center justify-end border-t border-gray-100 pt-5 mt-2">
        <button
          ...
          onClick={onNext}
          className="px-8 py-3.5 bg-[#3B82F6] hover:bg-[#2563EB] text-white font-black text-sm rounded-2xl shadow-xl hover:scale-105 transition-all disabled:opacity-40 disabled:scale-100 cursor-pointer disabled:cursor-not-allowed flex items-center gap-2"
        >
