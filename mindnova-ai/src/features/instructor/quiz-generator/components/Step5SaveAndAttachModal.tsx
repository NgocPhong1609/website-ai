...
export function Step5SaveAndAttachModal({ quiz, onClose }: Step5SaveAndAttachModalProps) {
 ...
 <div>
 <span className="text-xs font-bold -[#2C3039] uppercase tracking-wider">Lưu Thành Công</span>
 ...
 {attachedSuccess ? (
 <div className="p-6 rounded-2xl bg-emerald-50 border -[#FAF7F2] -[#2C3039] flex flex-col items-center justify-center text-center gap-3">
 <span className="text-4xl"></span>
 <h3 className="text-base font-extrabold">Đã Gắn Bài Kiểm Tra Vào Khóa Học Thành Công!</h3>
 <p className="text-xs font-medium -[#2C3039]">
 ...
 <div className="p-4 rounded-2xl bg-indigo-50/70 border -[#FAF7F2] flex items-center justify-between">
 <div className="flex items-center gap-3">
 
 <div>
 <div className="flex items-center gap-2">
 <span className="text-[10px] font-black -[#C0392B] uppercase tracking-wider">
 Khóa học được chọn
 </span>
 <span className="px-2 py-0.5 bg-white -[#C0392B] font-black text-[10px] rounded-md border -[#FAF7F2] shadow-2xs">
 ...
 <span className="text-xs font-mono font-extrabold -[#C0392B] block">
 ID: #{selectedCourseId}
 </span>
 ...
 {modules.length === 0 ? (
 <div className="p-3 rounded-xl bg-[#FEFCF9] border border-[#E8E2D9] text-xs font-bold text-[#8A8478]">
 ...
 className="px-6 py-2.5 bg-[#C0392B] hover:bg-[#4338CA] text-white text-xs font-black rounded-xl shadow-lg transition-all disabled:opacity-50 cursor-pointer flex items-center gap-2"
 >
