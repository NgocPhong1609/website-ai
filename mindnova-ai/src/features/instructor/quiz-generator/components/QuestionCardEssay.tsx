...
export function QuestionCardEssay({
  ...
  return (
    <div
      className={`p-6 rounded-3xl bg-white border-2 transition-all duration-200 shadow-sm flex flex-col gap-4 ${isApproved ? "-[#C0392B]/50 bg-purple-50/10 shadow-[0_4px_20px_rgba(168,85,247,0.05)]" : "border-[#FAF7F2]"
        }`}
    >
      {/* Top Header */}
      ...
      {isEditing ? (
        <div className="flex flex-col gap-4 pt-2">
          ...
          <div>
            ...
            <textarea
              ...
              rows={3}
              className="w-full p-3 rounded-xl border border-[#FAF7F2] text-xs font-medium text-gray-800 focus:outline-none focus:-[#C0392B]"
        ...
        <div className="flex flex-col gap-3">
          ...
          {rubricStr && (
            <div className="p-3.5 rounded-2xl bg-[#FEFCF9] border border-[#FAF7F2] flex flex-col gap-1 text-xs">
