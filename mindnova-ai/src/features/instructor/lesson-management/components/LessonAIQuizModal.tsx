...
export function LessonAIQuizModal({ lessonTitle = "Building Type-Safe Server Actions", isOpen, onClose, onConfirmDecks }: LessonAIQuizModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/65 backdrop-blur-md animate-fadeIn">
            <div className="bg-white rounded-3xl border border-[#FAF7F2] shadow-[0_30px_90px_rgba(0,0,0,0.3)] max-w-4xl w-full overflow-hidden flex flex-col max-h-[90vh]">
                ...
                <div className="p-6 overflow-y-auto flex-1 flex flex-col gap-6 bg-[#FAF8FF]">
                    ...
                    {questions.length === 0 && (
                        <div className="p-6 rounded-3xl bg-white border border-[#FAF7F2] shadow-xs flex flex-col gap-4">
                            <div className="flex flex-col gap-4 animate-fadeIn">
                                ...
                                <textarea
                                    ...
                                    rows={5}
                                    className="w-full p-4 rounded-2xl border -[#FAF7F2] bg-[#F8F9FF] text-xs font-medium text-gray-700 leading-relaxed focus:outline-none focus:border-[#FAF7F2] transition-colors"
                                                ...
                                                <div className="flex flex-col gap-3 pt-2">
                                                    <div>
                                                        ...
                                                        <input
                                                            ...
                                                            className="w-full p-3 rounded-xl border border-[#FAF7F2] font-bold text-sm text-[#2C3039]"
                                                        />
                                                    </div>
                                                    <div>
                                                ...
                                                <div className="flex flex-col gap-3">
                                                    ...
                                                    <div className="flex flex-col gap-2">
                                                        ...
                                                        {q.distractors.map((dist, dIdx) => (
                                                            <div key={dIdx} className="flex items-center gap-3 p-2.5 rounded-xl bg-[#FEFCF9] border border-[#FAF7F2] text-xs font-medium text-[#8A8478]">
                    ...
                    {!isGenerating && questions.length > 0 && activeQuestions.length === 0 && (
                        <div className="p-12 text-center rounded-3xl bg-white border border-[#FAF7F2] flex flex-col items-center gap-3 text-[#8A8478]">
                ...
                {/* Modal Footer */}
                <div className="p-4 px-6 bg-white border-t border-[#FAF7F2] flex items-center justify-between">
