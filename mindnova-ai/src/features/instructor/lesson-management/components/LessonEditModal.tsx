      ...
      <div className="relative w-full max-w-4xl bg-white rounded-2xl shadow-2xl flex flex-col max-h-full overflow-hidden animate-fadeIn">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#F0F0F8]">
          ...
          <button
            type="button"
            onClick={handleClose}
            className="w-8 h-8 rounded-lg flex items-center justify-center text-[#8A8478] hover:bg-[#FAF7F2] transition-colors"
          >
        ...
        <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col gap-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <input
                ...
                className="w-full px-4 py-2.5 rounded-xl text-sm border border-[#FAF7F2] focus:border-[#FAF7F2] focus:ring-2 focus:ring-[#C0392B]/20 outline-none transition-all"
              />
            </div>
            <div className="flex flex-col gap-1.5">
              ...
              <select
                ...
                className="w-full px-4 py-2.5 rounded-xl text-sm border border-[#FAF7F2] focus:border-[#FAF7F2] focus:ring-2 focus:ring-[#C0392B]/20 outline-none transition-all appearance-none bg-white"
              >
          ...
          <div className="flex flex-col gap-1.5 flex-1 min-h-[400px]">
            {type === 'quiz_module' ? (
              ...
              <div className="flex flex-col gap-3 mb-6 p-4 border border-[#FAF7F2] rounded-xl bg-[#F8F8FC]">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-lg font-medium transition-colors ${videoMethod === 'url' ? 'bg-[#C0392B] text-white' : 'bg-white text-[#8A8478] border border-[#FAF7F2]'}`}
                    >
                      Dùng URL
                    </button>
                    <button
                      ...
                      className={`text-xs px-3 py-1.5 rounded-lg font-medium transition-colors ${videoMethod === 'upload' ? 'bg-[#C0392B] text-white' : 'bg-white text-[#8A8478] border border-[#FAF7F2]'}`}
                    >
                      Tải lên
                    </button>
                  </div>
                ...
                {videoMethod === 'url' ? (
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl text-sm border border-[#FAF7F2] focus:border-[#FAF7F2] focus:ring-2 focus:ring-[#C0392B]/20 outline-none"
                  />
                ) : (
                ...
                {videoUrl && !isUploadingVideo && (
                  <div className="mt-2 w-full bg-black rounded-xl overflow-hidden border border-[#FAF7F2] flex items-center justify-center relative min-h-[300px]">
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-[#F0F0F8] bg-[#F8F8FC]">
          <button
            ...
            onClick={handleClose}
            disabled={isSaving}
            className="px-5 py-2.5 rounded-xl text-sm font-medium text-[#8A8478] bg-white border border-[#FAF7F2] hover:bg-[#FAF7F2] transition-colors disabled:opacity-50"
          >
            Hủy bỏ
          </button>
          <button
