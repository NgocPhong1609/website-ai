        ...
        <div className="flex flex-col min-h-screen bg-[#FAF8FF]">
            <main className="flex-1 overflow-y-auto">
                <div className="max-w-[1080px] mx-auto px-6 py-8 flex flex-col gap-8">
                    ...
                    <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 pb-6 border-b border-[#FAF7F2]">
                        <div>
                    ...
                    <div className="flex flex-col gap-6 animate-fadeIn">
                        ...
                        <div className="flex items-center justify-between flex-wrap gap-4">
                            <div className="flex items-center gap-1.5 bg-gray-100 p-1 rounded-xl border border-[#FAF7F2]">
                                {[
                        ...
                        {loading ? (
                            ...
                            <div className="p-16 text-center rounded-3xl bg-white border border-[#FAF7F2] flex flex-col items-center gap-2 text-gray-400">
                            ...
                            <div className="flex flex-col gap-6">
                                {filteredThreads.map((thread: any) => (
                                    <div key={thread.id} className="p-6 rounded-3xl bg-white border border-[#FAF7F2] shadow-xs flex flex-col gap-5">
