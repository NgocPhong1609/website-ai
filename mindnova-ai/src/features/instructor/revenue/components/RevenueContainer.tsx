        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2.5 flex-wrap">
                ...
                <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-extrabold text-white bg-[#C0392B] hover:bg-[#A93226] active:scale-95 shadow-sm transition-all cursor-pointer"
                >
                    <WalletIcon />
        ...
        <div className="p-6 rounded-2xl bg-white border border-[#FAF7F2] shadow-sm flex flex-col gap-5 animate-fadeIn">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 rounded-xl bg-indigo-50/60 border border-[#FAF7F2] flex flex-col justify-between gap-3">
                    ...
                    <Link
                        href="/instructor"
                        className="px-4 py-2 rounded-xl bg-[#C0392B] hover:bg-[#A93226] text-white text-xs font-extrabold transition-all text-center shadow-2xs"
                    >
                            ...
                            <div key={i} className="relative flex flex-col items-center w-full max-w-[42px] group cursor-pointer">
                                ...
                                <div
                                    className={twMerge(
                                        ...
                                        isToday ? "bg-[#C0392B] shadow-sm" : "bg-gray-200 group-hover:bg-[#FAF7F2]"
                                    )}
                                    style={{ height: `${h}px` }}
                                />
        ...
        <div className="flex flex-col min-h-screen bg-[#F4F4F8] font-sans">
            <main className="flex-1 overflow-y-auto">
                <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col gap-6 pb-16">
                    ...
                    {isLoading ? (
                        <div className="flex flex-col items-center justify-center py-20 text-[#C0392B]">
                            <></>
