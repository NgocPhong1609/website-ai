                            ...
                            <div key={d.id} className="flex items-start gap-3 p-3.5 hover:bg-[#FEFCF9]/80 transition-colors cursor-pointer">
                                {d.student?.avatar_url ? (
                                    <img
                                        ...
                                        alt={d.student.name}
                                        className="w-8 h-8 rounded-xl shadow-2xs object-cover shrink-0"
                                        onError={(e) => {
                                ...
                                <div style={{ display: d.student?.avatar_url ? 'none' : 'flex' }}>
        ...
        <div className="rounded-2xl border border-[#FAF7F2] bg-red-50/20 shadow-2xs overflow-hidden">
            ...
            <div className="p-4 flex flex-col gap-3">
                ...
                <textarea
                    ...
                    rows={3}
                    className="w-full px-3.5 py-2.5 rounded-xl border border-[#FAF7F2] bg-white text-xs font-medium text-[#2C3039] placeholder:text-gray-400 focus:outline-none focus:border-[#C0392B] resize-none shadow-2xs"
                />
                        ...
                        <button
                            ...
                            className={twMerge(
                                ...
                                activeTag === tag
                                    ...
                                    : "border-[#FAF7F2] text-[#8A8478] bg-white hover:text-[#C0392B]"
                            )}
                        >
                            + {tag}
                        </button>
                ...
                <button
                    ...
                    className="flex items-center justify-center gap-2 w-full py-2.5 rounded-xl text-xs font-extrabold text-white bg-[#C0392B] hover:bg-[#A93226] shadow-sm transition-all cursor-pointer mt-1"
                >
                    <PlusIcon size={14} />
    ...
    return (
        <div className="flex flex-col gap-1.5">
            <div className="flex items-center justify-between">
                ...
                <span className={twMerge("text-xs font-black font-mono", color === "red" ? "text-rose-600" : "text-[#C0392B]")}>
                    {value}
                </span>
            </div>
            ...
            <div className="p-4 flex flex-col gap-4">
                {isLoading ? (
                    ...
                    <>
                        ...
                        <div className="rounded-xl bg-[#FAF7F2] border border-[#FAF7F2] p-3.5 flex items-start gap-2.5 mt-2">
                            <span className="text-[#C0392B] mt-0.5 shrink-0"><TrendUpIcon size={16} /></span>
                            <div className="flex flex-col gap-0.5">
                                <span className="text-[11px] font-black text-[#C0392B] uppercase tracking-wider">Gợi ý Tối ưu AI</span>
                                <p className="text-xs text-[#2C3039] leading-relaxed font-medium">
