    ...
    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
      ...
      <div className="flex items-center gap-2.5 flex-wrap shrink-0">
        ...
        <button
          ...
          onClick={onOpenModal}
          className="flex items-center gap-2 px-4.5 py-2 rounded-xl text-xs font-extrabold text-white bg-[#3B82F6] hover:bg-[#2563EB] shadow-sm transition-all cursor-pointer"
        >
