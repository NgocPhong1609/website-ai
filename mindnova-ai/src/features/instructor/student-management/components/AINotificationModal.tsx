...
function EditorToolbar({ onFormat }: { onFormat: (cmd: string) => void }) {
    ...
    return (
        <div className="flex items-center gap-0.5 px-2 py-1.5 bg-[#F8F8FD] border-b border-[#FAF7F2]">
        ...
        <div className="flex flex-col gap-4 pr-5 border-r border-[#F0F0F8]">
            ...
            <div className="flex flex-col gap-1.5">
                ...
                <textarea
                    ...
                    rows={5}
                    className="w-full px-3 py-2.5 rounded-xl border border-[#DDDDF0] bg-[#FAFAFE] text-[13px] text-[#2C3039] placeholder:text-[#C4C4D8] focus:outline-none focus:border-[#FAF7F2] focus:ring-2 focus:ring-[#C0392B]/15 transition-all duration-150 resize-none leading-relaxed"
                />
            </div>
                ...
                >
                    ...
                    <div className="flex items-start gap-3 px-6 py-5 border-b border-[#F0F0F8]">
                        ...
                        <button
                            ...
                            onClick={onClose}
                            aria-label="Đóng"
                            className="w-8 h-8 rounded-xl flex items-center justify-center text-[#8A8478] hover:text-[#2C3039] hover:bg-[#FAF7F2] transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#EAEAF4] shrink-0"
                        >
                            <XIcon />
                        </button>
                    </div>
                            ...
                            {isGenerating ? (
                                <div className="flex flex-col h-full">
                                    ...
                                    <div className="flex-1 rounded-xl border border-[#DDDDF0] bg-white overflow-hidden">
                                        <div className="px-3 py-2 bg-[#F8F8FD] border-b border-[#FAF7F2] flex gap-1">
                                            {[...Array(5)].map((_, i) => (
                                ...
                                <div className="flex-1 flex flex-col items-center justify-center gap-3 text-[#C4C4D8] border-2 border-dashed border-[#FAF7F2] rounded-xl">
