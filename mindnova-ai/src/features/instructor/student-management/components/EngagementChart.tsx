...
export function EngagementChart({ data, timeRange, setTimeRange }: { data: any[], timeRange: number, setTimeRange: (val: number) => void }) {
    ...
    return (
        <div className="bg-white p-6 rounded-2xl border border-[#FAF7F2] shadow-2xs flex flex-col gap-6 w-full h-full">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                ...
                <div className="relative">
                    <button
                        ...
                        className="flex items-center justify-between w-[130px] bg-white border border-[#FAF7F2] text-gray-700 text-xs font-bold rounded-xl px-4 py-2 hover:bg-[#FEFCF9] focus:outline-none focus:-[#C0392B] cursor-pointer shadow-sm transition-colors"
                    >
