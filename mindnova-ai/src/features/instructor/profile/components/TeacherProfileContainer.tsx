...
export function TeacherProfileContainer() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-8 space-y-8">
      ...
      <div className="relative rounded-3xl border border-[#FAF7F2]/80 bg-white p-6 md:p-8 shadow-sm overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1 text-center md:text-left space-y-2">
            ...
            <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 pt-1">
              ...
              <span
                className={`px-3 py-1 rounded-full text-xs font-bold border uppercase tracking-wide ${isVerified
                  ? "bg-emerald-50 -[#2C3039] -[#FAF7F2]"
                  : status === "pending"
                    ? "bg-amber-50 text-amber-700 border-amber-200"
                    : status === "rejected"
                      ? "bg-rose-50 text-rose-700 border-rose-200"
                      : "bg-gray-100 text-[#8A8478] border-[#FAF7F2]"
                  }`}
              >
                {isVerified
      ...
      {msg.text && (
        <div
          className={`p-4 rounded-2xl border text-sm font-bold ${msg.type === "success"
            ? "bg-emerald-50 -[#2C3039] -[#FAF7F2]"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="rounded-3xl border border-[#FAF7F2] bg-white p-6 shadow-sm space-y-4">
                ...
                {profileData.certificates.map((cert: any) => (
                  ...
                  >
                    <div className="flex items-start justify-between gap-2">
                      ...
                      <span
                        className={`text-[10px] font-black px-2 py-0.5 rounded-full border ${cert.verification_status === "approved"
                          ? "bg-emerald-50 -[#2C3039] -[#FAF7F2]"
                    ...
                    {cert.certificate_image && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="block mt-2 rounded-xl overflow-hidden border border-[#FAF7F2] h-24 bg-gray-100"
                      >
                        <img
                    ...
                    <div className="flex items-center justify-between pt-1 border-t border-[#FAF7F2]/50 text-[11px] text-gray-400">
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Edit Profile Form */}
          <div className="rounded-3xl border border-[#FAF7F2] bg-white p-6 md:p-8 shadow-sm space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-[#FAF7F2] text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-[#C0392B]"
                  />
                </div>
          ...
          {/* Teacher's Courses */}
          <div className="rounded-3xl border border-[#FAF7F2] bg-white p-6 md:p-8 shadow-sm space-y-4">
