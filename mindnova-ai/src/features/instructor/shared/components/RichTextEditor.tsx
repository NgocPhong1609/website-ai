...
const renderVideoPreview = (url: string) => {
  ...
  return `
 <div style="width: 100%; max-width: 100%; padding: 24px; border-radius: 12px; background-color: #FAF7F2; border: 2px dashed #D5D5F0; display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 12px; cursor: default;">
    ...
    <div className="flex flex-col gap-2 relative z-0">
      ...
      {showMenu && (
        <>
          ...
          <div className="absolute top-12 left-1/2 -translate-x-1/2 z-50 w-56 bg-white rounded-xl shadow-lg border border-[#FAF7F2] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="p-1.5 flex flex-col">
              <button
                ...
                className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-[#2C3039] hover:bg-[#FAF7F2] hover:text-[#C0392B] rounded-lg transition-colors w-full text-left disabled:opacity-50"
              >
                <></>
                Tải video từ máy
              </button>
              <button
                ...
                className="flex items-center gap-3 px-3 py-2.5 text-sm font-medium text-[#2C3039] hover:bg-[#FAF7F2] hover:text-[#C0392B] rounded-lg transition-colors w-full text-left"
              >
                <></>
                Gắn liên kết video
              </button>
      ...
      {isUploading && (
        <div className="absolute inset-0 z-50 flex flex-col items-center justify-center bg-white/80 backdrop-blur-sm rounded-lg border border-[#FAF7F2]">
          ...
          <div className="w-48 h-1.5 bg-[#FAF7F2] rounded-full mt-3 overflow-hidden">
            <div
