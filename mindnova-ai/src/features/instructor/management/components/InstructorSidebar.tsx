...
export function InstructorSidebar() {
  ...
  return (
    <aside className={twMerge("shrink-0 h-full flex flex-col bg-white border-r border-gray-200 shadow-sm z-50 transition-all duration-300", isCollapsed ? "w-[80px]" : "w-[260px]")}>
      {/* Brand */}
      <div className={twMerge("py-5 border-b border-gray-100 flex justify-center", isCollapsed ? "px-2" : "px-4")}>
