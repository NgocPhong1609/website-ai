...
function LogoMark() {
    return (
        <div className="w-9 h-9 rounded-xl bg-[#C0392B] to-[#A93226] text-white flex items-center justify-center font-black text-lg shadow-md shrink-0 border -[#FAF7F2]">
    ...
    return (
        <div className="px-1 py-1 shrink-0">
            <Link
                ...
                className="flex items-center justify-center gap-2 px-4 py-3 w-full rounded-xl text-xs font-black text-white bg-[#C0392B] hover:bg-[#a8392b] shadow-md transition-all duration-200"
            >
    ...
    return (
        <div className={twMerge("relative flex py-2", isCollapsed ? "flex-col gap-3 items-center" : "items-center gap-3 px-2")} ref={dropdownRef}>
            <button
                ...
                className="w-9 h-9 rounded-xl bg-[#C0392B] text-white flex items-center justify-center text-sm font-black shadow-2xs shrink-0 overflow-hidden hover:ring-2 hover:ring-[#C0392B]/50 transition-all focus:outline-none"
            >
                {avatarUrl ? (
            ...
            {isDropdownOpen && (
                <div className={twMerge(
                    "absolute z-50 bg-white border border-[#FAF7F2] rounded-xl shadow-lg py-1 min-w-[160px] overflow-hidden",
            ...
            <Link
                ...
                className={twMerge(
                    ...
                    isActive
                        ...
                        : "text-[#8A8478] hover:bg-[#FAF7F2] hover:text-[#2C3039]",
                )}
            >
                <span
                    className={twMerge(
...
export function InstructorSidebar() {
    ...
    return (
        <aside className={twMerge("shrink-0 h-full flex flex-col bg-white border-r border-[#FAF7F2] shadow-sm z-50 transition-all duration-300", isCollapsed ? "w-[80px]" : "w-[234px]")}>
            {/* Brand */}
            <div className={twMerge("h-16 shrink-0 border-b border-[#FAF7F2] flex items-center justify-center", isCollapsed ? "px-2" : "px-4")}>
            ...
            <div className={twMerge("pb-4", isCollapsed ? "px-2" : "px-4")}>
                {isCollapsed ? (
                    <Link
                        href="/instructor/create-course"
                        title="Create New Course"
                        className="flex items-center justify-center w-full h-10 rounded-xl text-xs font-black text-white bg-[#C0392B] hover:bg-[#A93226] shadow-md transition-all duration-200"
                    >
                        <svg aria-hidden viewBox="0 0 24 24" width={16} height={16} fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" className="shrink-0">
                            <line x1="12" y1="5" x2="12" y2="19" />
                            <line x1="5" y1="12" x2="19" y2="12" />
            ...
            <div className={twMerge("py-3 border-t border-gray-100 flex flex-col gap-3", isCollapsed ? "px-2" : "px-3")}>
                ...
                <button
                    ...
                    className={twMerge("flex items-center gap-2 px-3 py-2 text-xs font-bold text-[#8A8478] hover:text-[#2C3039] transition-colors border border-[#FAF7F2] rounded-xl hover:bg-[#FEFCF9] group", isCollapsed ? "justify-center" : "justify-between w-full")}
                >
                    {isCollapsed ? (
                        ...
                        <>
                            ...
                            <span className="px-1.5 py-0.5 rounded bg-gray-100 border border-[#FAF7F2] text-[10px] font-black tracking-widest text-gray-400 group-hover:text-[#8A8478] group-hover:border-gray-300 transition-colors">Ctrl+B</span>
                        </>
                    )}
                </button>
            </div>
