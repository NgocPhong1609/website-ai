...
export function CreateCourseCard() {
    return (
        ...
        >
            <div className="w-12 h-12 rounded-full bg-[#FEFCF9] border border-[#FAF7F2] flex items-center justify-center text-[#8A8478] group-hover:border-[#C0392B] group-hover:text-white group-hover:bg-[#C0392B] group-hover:scale-105 transition-all duration-200 shadow-2xs">
                <PlusIcon size={22} />
            </div>
