...
function UserAvatar() {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            ...
            {isDropdownOpen && (
                <div className="absolute right-0 mt-2 w-48 bg-white border border-[#FAF7F2] rounded-xl shadow-lg py-1 z-50">
                    <Link
...
export function InstructorTopbar() {
    ...
    return (
        <header className="h-16 shrink-0 flex items-center justify-between px-6 bg-white border-b border-[#FAF7F2] relative z-40 shadow-2xs">
            {/* Brand & Context */}
            <div className="flex items-center gap-3">
                {/* Placeholder for sidebar open button if needed on mobile, removed SidebarOpenButton to avoid missing module error */}
                <button type="button" className="md:hidden w-9 h-9 rounded-xl flex items-center justify-center border border-[#FAF7F2] bg-[#FEFCF9] text-[#8A8478]">
            ...
            <div className="flex items-center gap-3">
                ...
                {unansweredDiscussionsCount > 0 && (
                    <Link
                        ...
                        className="hidden md:flex items-center gap-1.5 px-3 py-1 rounded-xl bg-[#FEFCF9] text-[#2C3039] border border-[#FAF7F2] hover:bg-[#FAF7F2] hover:text-[#C0392B] hover:-[#FAF7F2] text-xs font-bold transition-all cursor-pointer text-decoration-none"
                    >
                ...
                <Link
                    ...
                    className="relative w-9 h-9 rounded-xl flex items-center justify-center border border-[#FAF7F2] bg-[#FEFCF9] text-[#8A8478] hover:bg-[#FAF7F2] hover:text-[#C0392B] hover:-[#FAF7F2] transition-all cursor-pointer"
                >
                ...
                <div className="relative">
                    <button
                        ...
                        className={twMerge(
                            "relative w-9 h-9 rounded-xl flex items-center justify-center border border-[#FAF7F2] transition-all cursor-pointer",
                    ...
                    {isAlertOpen && (
                        <div className="absolute right-0 top-12 w-80 sm:w-96 rounded-2xl bg-white border border-[#FAF7F2] shadow-lg p-5 flex flex-col gap-4 z-50 animate-in fade-in slide-in-from-top-2 duration-150">
