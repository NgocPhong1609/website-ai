                ...
                <button
                    ...
                    className={twMerge(
                        ...
                        value === key
                            ...
                            : "border-[#FAF7F2] bg-white text-[#8A8478] hover:border-gray-300 hover:text-[#2C3039] hover:bg-[#FEFCF9]/70"
                    )}
                >
                    {label}
                </button>
...
export function Step1BasicInfo({ data, onChange }: Step1BasicInfoProps) {
    ...
    return (
        <div className="flex flex-col gap-6 animate-fadeIn">
            <div className="flex items-center justify-between border-b border-[#FAF7F2] pb-4 bg-white p-5 rounded-2xl shadow-2xs">
                <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-[280px_1fr] gap-6">
                ...
                <div className="flex flex-col gap-5 bg-white p-6 rounded-2xl border border-[#FAF7F2] shadow-2xs">
                    {/* Course title */}
                    <div className="flex flex-col gap-1.5">
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2.5 rounded-xl text-xs font-bold text-[#2C3039] placeholder:text-gray-400 placeholder:font-normal bg-[#FEFCF9]/50 border border-[#FAF7F2] focus:outline-none focus:border-[#C0392B] focus:bg-white transition-all shadow-2xs"
                        />
                    </div>
                    ...
                    <div className="flex flex-col gap-1.5">
                        ...
                        <textarea
                            ...
                            className="w-full px-4 py-3 rounded-xl text-xs font-medium text-[#2C3039] placeholder:text-gray-400 placeholder:font-normal bg-[#FEFCF9]/50 border border-[#FAF7F2] focus:outline-none focus:border-[#C0392B] focus:bg-white transition-all resize-none leading-relaxed shadow-2xs"
                        />
                    </div>
                        ...
                        <div className="flex flex-col gap-1.5">
                            ...
                            <div className="relative">
                                <select
                                    ...
                                    className={`w-full appearance-none px-4 py-2.5 pr-10 rounded-xl text-xs bg-[#FEFCF9]/50 border border-[#FAF7F2] focus:outline-none focus:border-[#C0392B] focus:ring-2 focus:ring-[#C0392B]/20 focus:bg-white transition-all cursor-pointer shadow-2xs ${!data.field ? "text-gray-400 font-normal" : "text-[#2C3039] font-bold"
                                        }`}
                                >
