...
export function Step3SettingsPrice({
  ...
  return (
    <div className="w-full flex flex-col gap-6 animate-fadeIn">
      {/* Top Title Banner */}
      <div className="p-5 rounded-2xl bg-white border border-[#FAF7F2] shadow-2xs">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-7 flex flex-col gap-5">
          ...
          {/* Free vs Paid Toggle */}
          <div className="p-5 rounded-2xl bg-white border border-[#FAF7F2] shadow-2xs flex flex-col gap-4">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              ...
              <div className="flex items-center gap-1 p-1 rounded-xl bg-gray-100 border border-[#FAF7F2] w-fit shrink-0">
                <button
                  type="button"
                    ...
                    <input
                      ...
                      className={twMerge(
                        ...
                        validationError
                          ...
                          : "border-[#FAF7F2] bg-[#FEFCF9]/50 text-[#2C3039] focus:border-[#C0392B] focus:bg-white"
                      )}
                      placeholder="500000"
                    />
                    ...
                    <button
                      ...
                      className={twMerge(
                        ...
                        tier === "standard"
                          ...
                          : "border-[#FAF7F2] bg-white hover:border-gray-300"
                      )}
                    >
          ...
          {!isFree && (
            <div className="p-5 rounded-2xl bg-white border border-[#FAF7F2] shadow-2xs flex flex-col gap-4 animate-fadeIn">
                ...
                <div className="pt-4 border-t border-gray-100 grid grid-cols-1 sm:grid-cols-3 gap-3 animate-fadeIn">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 rounded-xl border border-[#FAF7F2] font-black font-mono text-xs -[#2C3039] focus:outline-none focus:-[#2C3039] bg-[#FEFCF9]/50"
                    />
                  </div>
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2 rounded-xl border border-[#FAF7F2] font-bold text-xs text-gray-700 focus:outline-none bg-[#FEFCF9]/50"
                    />
                  </div>
                  <div>
