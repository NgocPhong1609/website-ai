...
export function Step3SettingsPrice({
 ...
 >
 <p className="text-xs font-extrabold text-[#2C3039]">{"label" in definition ? definition.label : definition.tier}</p>
 {"platform_commission_percent" in definition && (
 <p className="text-[11px] text-[#C0392B] font-bold mt-0.5">
