...
export function AIOutlineModal({ isOpen, onClose, onApply }: AIOutlineModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
            <div className="bg-white rounded-3xl border border-[#FAF7F2] shadow-[0_25px_80px_rgba(0,0,0,0.25)] max-w-3xl w-full overflow-hidden flex flex-col max-h-[90vh]">
                        ...
                        <div className="flex flex-col gap-5 animate-fadeIn">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 rounded-2xl border-2 border-[#D5D5FF] text-[#2C3039] font-bold text-sm focus:outline-none focus:border-[#FAF7F2] transition-all"
                                />
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-4 py-2.5 rounded-2xl border border-gray-300 text-xs font-bold text-[#2C3039] focus:outline-none focus:border-[#FAF7F2]"
                                    />
                                </div>
                                <div>
                                    <label className="block text-xs font-black text-[#2C3039] uppercase tracking-wide mb-1.5">
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-2.5 rounded-2xl border border-gray-300 text-xs font-bold text-[#2C3039] bg-white focus:outline-none focus:border-[#FAF7F2]"
                                    >
                                    ...
                                    <button
                                        ...
                                        className={twMerge(
                                            ...
                                            methodology.includes("80/20")
                                                ? "border-[#FAF7F2] bg-[#F0F0FF] text-[#C0392B] shadow-xs font-bold"
                                ...
                                <div className="flex flex-col gap-4">
                                    ...
                                    <div className="flex flex-col gap-4 max-h-[360px] overflow-y-auto pr-2">
                                        {outline.chapters.map((ch, cIdx) => (
                                            <div key={cIdx} className="p-4 rounded-2xl bg-[#F8F9FF] border border-[#FAF7F2] flex flex-col gap-3">
                                                <div className="flex items-center justify-between">
                ...
                {/* Footer */}
                <div className="p-4 px-6 bg-[#F8F9FF] border-t border-[#FAF7F2] flex items-center justify-between">
                    <button
                        type="button"
                        onClick={onClose}
