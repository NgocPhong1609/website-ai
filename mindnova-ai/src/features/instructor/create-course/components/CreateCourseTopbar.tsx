        ...
        <header className="h-[60px] shrink-0 flex items-center justify-between px-6 bg-white border-b border-[#F0F0F8]">
            ...
            <nav className="flex items-center gap-1" aria-label="Liên kết hỗ trợ">
                <Link
                    ...
                    className="px-3 py-2 rounded-lg text-sm text-[#8A8478] hover:bg-[#FAF7F2] hover:text-[#2C3039] transition-all duration-150"
                >
                    Hướng dẫn
                </Link>
                <Link
                ...
                <button
                    type="button"
                    aria-label="Trợ giúp"
                    className="w-8 h-8 rounded-lg flex items-center justify-center text-[#8A8478] hover:bg-[#FAF7F2] hover:text-[#C0392B] transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#C0392B]/30"
                >
                    <HelpCircleIcon />
                </button>
                ...
                <button
                    ...
                    className="relative w-8 h-8 rounded-lg flex items-center justify-center text-[#8A8478] hover:bg-[#FAF7F2] hover:text-[#C0392B] transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-[#C0392B]/30"
                >
                    <BellIcon />
