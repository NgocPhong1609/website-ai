    ...
    return (
        <div className="flex flex-col w-full h-full px-8 sm:px-10 py-6">
            ...
            <div className="flex flex-col justify-center w-full max-w-[480px] mx-auto py-6">
                ...
                {statusMessage && (
                    <div
                        className={`mb-3 p-3 rounded-xl text-xs font-medium border ${statusMessage.includes("thành công")
                ...
                <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3">
                    {/* Role Selection */}
                    <div className="flex p-1 bg-[#FEFCF9] rounded-xl border border-[#FAF7F2]">
                        <button
                            type="button"
                            onClick={() => setValues(prev => ({ ...prev, role: "student" }))}
                            className={`flex-1 py-1.5 text-[13px] font-semibold rounded-lg transition-all duration-200 ${values.role === "student"
                        ...
                        <button
                            ...
                            className={`flex-1 py-1.5 text-[13px] font-semibold rounded-lg transition-all duration-200 ${values.role === "teacher"
                                ? "bg-white text-[#C0392B] shadow-sm"
                                : "text-[#8A8478] hover:text-[#C0392B]"
                                }`}
                        >
