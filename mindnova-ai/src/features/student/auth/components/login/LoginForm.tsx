                ...
                <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-3">
                    ...
                    >
                        <div className="relative">
                            ...
                            />
                            <div className="w-[18px] h-[18px] rounded-[5px] border-2 border-[#D0D0E8] bg-white peer-checked:bg-[#FAF7F2] peer-checked:border-[#FAF7F2] transition-all duration-200 flex items-center justify-center shadow-sm group-hover:border-[#FAF7F2]">
                                {values.rememberMe && (
                                    <></>
                                )}
                            </div>
