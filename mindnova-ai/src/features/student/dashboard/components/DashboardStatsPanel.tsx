...
function OverallProgressCard({ data }: { data: OverallProgress }) {
    ...
    return (
        <Link
            href="/progress"
            className="group bg-white rounded-xl p-5 border border-[#FAF7F2] hover:border-[#B8B0A3] transition-all duration-300 flex flex-col justify-between gap-4 text-decoration-none focus:outline-none"
        >
            ...
            <div className="pt-3 border-t border-[#F5F0E8] space-y-1.5">
                ...
                <div className="h-2 rounded-full bg-[#F5F0E8] overflow-hidden p-0.5 border border-[#FAF7F2]">
                    <div
...
const ACTION_STYLES: Record<FocusActionKind, string> = {
    review: "bg-[#F5F0E8] text-[#2C3039] hover:bg-[#2C3039] hover:text-white border border-[#FAF7F2]",
...
function FocusAreaRow({ area }: { area: FocusAreaType }) {
    ...
    return (
        <div className="group/row flex items-center justify-between gap-2 p-2 rounded-lg hover:bg-[#FAF7F2] transition-colors border border-transparent hover:border-[#FAF7F2]">
...
function FocusAreasCard({ areas }: { areas: FocusAreaType[] }) {
    ...
    return (
        <div className="bg-white rounded-xl p-5 border border-[#FAF7F2] hover:border-[#B8B0A3] transition-all duration-300 flex flex-col justify-between gap-4">
            <div>
