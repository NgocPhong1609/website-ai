    ...
    return (
        <div className="flex-1 overflow-y-auto bg-[#FAF7F2] min-h-full">
            <div className="max-w-[1100px] mx-auto p-6 lg:p-8 pb-20">
                ...
                {/* ─── Banner ────────────────────────────────────────────────────────────── */}
                <div className="bg-[#FEFCF9] rounded-2xl p-8 lg:p-10 flex flex-col md:flex-row justify-between items-start md:items-center relative overflow-hidden border border-[#FAF7F2]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
                    ...
                    <div className="lg:col-span-2 flex flex-col gap-6">
                        ...
                        {/* Smart Next Step */}
                        <div className="bg-white rounded-2xl p-6 lg:p-8 relative border border-[#FAF7F2]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {/* Overall Progress */}
                            <div className="bg-white rounded-2xl p-6 border border-[#FAF7F2] flex flex-col justify-between">
                            ...
                            {/* Recent Activity */}
                            <div className="bg-white rounded-2xl p-6 border border-[#FAF7F2]">
                    ...
                    <div className="lg:col-span-1 flex flex-col gap-6">
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-[#FAF7F2]">
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                {/* Normal Area */}
                                <div className="bg-[#FAF7F2] border border-[#FAF7F2] rounded-xl p-4">
                                    <div className="flex justify-between items-center mb-1.5">
                            ...
                            <button className="w-full mt-6 py-3 rounded-lg border-2 border-[#FAF7F2] text-[#2C3039] font-bold text-[14px] hover:bg-[#F5F0E8] transition-colors focus:outline-none focus:ring-2 focus:ring-[#FAF7F2]">
                        ...
                        <div className="bg-white rounded-2xl p-6 border border-[#FAF7F2]">
                            ...
                            <div className="flex gap-4">
                                ...
                                {/* Badge 3 (Locked) */}
                                <div className="w-14 h-14 rounded-full border-2 border-dashed border-[#FAF7F2] flex items-center justify-center text-[#B8B0A3] text-xs font-medium">
                                    ?
                                </div>
                            </div>
                        </div>
