...
export function DashboardTopbar() {
    ...
    return (
        <>
            <header className="sticky top-0 z-50 h-18 shrink-0 flex items-center justify-end gap-4 px-6 lg:px-8 bg-[#FEFCF9]/95 backdrop-blur-sm border-b border-[#FAF7F2] transition-all duration-200">
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1 bg-[#F5F0E8] p-1 rounded-lg border border-[#FAF7F2]">
                        {/* Chat Button */}
                        <a
                            href="/messages"
                            aria-label="Messages"
                        ...
                        <div className="relative">
                            ...
                            {showNotif && (
                                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-[#FAF7F2] overflow-hidden z-50">
                    ...
                    <span className="w-px h-6 bg-[#FAF7F2] hidden sm:block" />
                        ...
                        >
                            <div className="group/avatar hover:scale-105 active:scale-95 transition-transform duration-200">
                                <Avatar
                                    ...
                                    size="md"
                                    className="ring-2 ring-[#FAF7F2] hover:ring-[#C0392B]/40 transition-all duration-200"
                                />
                            </div>
                            {user?.name && (
