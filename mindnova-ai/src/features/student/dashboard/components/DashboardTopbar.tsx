          ...
          {isMounted && isLoggedIn ? (
            <div className="flex items-center gap-1 bg-[#F6F6FB] p-1 rounded-xl border border-[#EAEAF4]">
              ...
              <a
                href="/messages"
                aria-label="Messages"
                className="group/chat relative w-9 h-9 rounded-lg flex items-center justify-center text-[#64647A] hover:text-[#4648D4] hover:bg-white hover:shadow-2xs transition-all duration-200 focus:outline-none text-decoration-none"
              >
                  ...
                  <div className="absolute right-0 mt-2 w-80 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden z-50">
                    ...
                    <div className="px-4 py-3 border-t border-gray-100 flex items-center justify-center bg-gray-50/50">
                      <button
                        ...
                        className="text-xs font-semibold text-red-600 hover:text-red-700 disabled:text-gray-400 transition-colors cursor-pointer"
                      >
