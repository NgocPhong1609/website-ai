...
export function AiSuggestionCard({ suggestion = AI_SUGGESTION }: AiSuggestionCardProps) {
    return (
        <div className="group relative overflow-hidden rounded-xl bg-white border border-[#FAF7F2] p-5 hover:border-[#B8B0A3] transition-all duration-300 w-full">
                ...
                <div className="flex-1 min-w-0 space-y-2.5">
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-2">
                        <div className="flex items-center gap-2">
                            <span className="inline-flex items-center gap-1.5 px-3 py-0.5 rounded-full bg-[#FAF7F2] text-[#C0392B] text-xs font-semibold border border-[#FAF7F2]">
                                Gợi ý từ Trợ lý AI Nova
                            </span>
                            <span className="inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full bg-[#FAF7F2] text-xs font-medium text-[#8A8478] border border-[#FAF7F2]">
                                Thời gian: 15 phút
                            </span>
                        </div>
                    ...
                    <div className="flex items-center gap-2 text-xs text-[#8A8478] font-normal italic bg-[#FAF7F2] px-3 py-2 rounded-lg border border-[#FAF7F2]">
                    ...
                    <div className="flex flex-wrap items-center gap-3 pt-1">
                        ...
                        <Link
                            href="/study-plan"
                            className="py-2.5 px-4 rounded-lg text-xs sm:text-sm font-semibold text-[#8A8478] hover:text-[#2C3039] bg-white hover:bg-[#F5F0E8] border border-[#FAF7F2] hover:border-[#B8B0A3] transition-all text-decoration-none"
                        >
