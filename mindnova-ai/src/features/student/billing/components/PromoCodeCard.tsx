...
export function PromoCodeCard() {
    ...
    return (
        <div className="rounded-2xl bg-white border border-[#FAF7F2] shadow-2xs p-6 flex flex-col gap-5 transition-all duration-300 hover:shadow-sm">
            {/* Header */}
                ...
                <div className="flex flex-wrap items-center gap-2 pt-1">
                    ...
                    {[
                        ...
                        <button
                            ...
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#F4F5FD] hover:bg-[#FAF7F2] border border-[#FAF7F2] hover:border-[#FAF7F2] text-xs font-medium text-[#C0392B] transition-all duration-150 cursor-pointer shadow-2xs"
                        >
