        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 w-full">
          <div className="space-y-4 max-w-xl">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold tracking-tight text-[#1A1A2E] leading-tight">
              Quản Lý &amp; <span className="bg-gradient-to-r from-[#4648D4] via-[#6063EE] to-[#4CD7F6] bg-clip-text text-transparent font-bold drop-shadow-2xs">Thanh Toán Trực Tuyến 💳</span>
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-3 pt-1">
              <button
                ...
                className="px-6 py-2.5 rounded-xl text-xs sm:text-sm font-semibold text-white bg-gradient-to-r from-[#5052EE] via-[#6063EE] to-[#0D9488] shadow-[0_4px_14px_rgba(80,82,238,0.35)] hover:shadow-[0_6px_22px_rgba(80,82,238,0.5)] transition-all duration-200 cursor-pointer focus:outline-none flex items-center gap-2"
              >
          ...
          <div className="group shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-5 sm:p-6 border border-[#6B6BFF]/20 flex flex-col justify-center min-w-[320px] sm:min-w-[380px] shadow-sm hover:border-[#6B6BFF]/50 hover:-translate-y-0.5 transition-all duration-300">
            <div className="w-full flex items-center justify-between gap-4 mb-2">
              <span className="text-xs font-semibold text-[#7878A0] group-hover:text-[#4648D4] transition-colors">Gói cước đang kích hoạt ↗</span>
              <span className="text-[11px] font-semibold text-[#0D9488] bg-[#CCFBF1] px-3 py-0.5 rounded-full border border-[#10B981]/20">
                Đặc quyền VIP
              </span>
            </div>
            ...
            <div className="text-2xl sm:text-3xl font-bold text-[#1A1A2E] my-1 flex items-baseline justify-between gap-4">
              <div>
                <span className="text-[#4648D4] font-bold">{UPCOMING_PAYMENT.amount}</span>
                <span className="text-xs font-medium text-[#9090B0] ml-1.5">/ kỳ</span>
              </div>
            ...
            <p className="text-xs font-semibold text-[#6B6BFF] mt-3.5 flex items-center justify-between gap-4">
              <span className="truncate">🔥 Mở khóa toàn bộ tính năng AI</span>
              <span className="text-[#4648D4] font-semibold cursor-pointer hover:underline shrink-0">Chi tiết gói Pro ➔</span>
            </p>
          </div>
        </div>
      </section>
