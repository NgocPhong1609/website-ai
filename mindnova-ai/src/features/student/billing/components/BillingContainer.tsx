...
export default function BillingContainer() {
    return (
        <div className="p-6 md:p-8 max-w-[1400px] mx-auto min-h-full flex flex-col gap-8">
            ...
            <section className="relative overflow-hidden rounded-2xl bg-[#FEFCF9] border border-[#FAF7F2] p-6 sm:p-7 shadow-[0_8px_30px_rgba(192,57,43,0.07)] transition-all duration-300 hover:shadow-[0_12px_36px_rgba(192,57,43,0.12)] w-full">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 w-full">
                    <div className="space-y-4 max-w-xl">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/95 backdrop-blur-md border border-[#FAF7F2] text-xs font-semibold text-[#C0392B] shadow-sm">
                    ...
                    <div className="group shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-5 sm:p-6 border border-[#FAF7F2] flex flex-col justify-center min-w-[320px] sm:min-w-[380px] shadow-sm hover:border-[#FAF7F2] hover:-translate-y-0.5 transition-all duration-300">
