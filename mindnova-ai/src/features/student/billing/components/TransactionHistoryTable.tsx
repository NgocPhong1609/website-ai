...
function TransactionRow({ tx }: { tx: Transaction }) {
 ...
 className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl text-xs font-semibold text-[#C0392B] bg-[#FAF7F2] hover:bg-[#FAF7F2] hover:text-[#C0392B] border border-[#C0392B]/20 hover:border-[#C0392B]/40 transition-all duration-150 cursor-pointer shadow-2xs"
