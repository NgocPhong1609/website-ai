  ...
  return (
    <button
      ...
      className={twMerge(
        ...
        isActive
          ? "bg-[#F0F2FF] text-[#C0392B] font-semibold shadow-2xs border border-[#FAF7F2]"
          : "text-[#8A8478] hover:bg-[#F8FAFC] hover:text-[#2C3039] border border-transparent hover:border-[#FAF7F2]"
      )}
    >
...
export function ProfileSidebar({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <hr className="border-t border-[#FAF7F2]" />
      ...
      {/* Quick Status Box */}
      <div className="p-3 rounded-xl bg-[#F8FAFC] border border-[#FAF7F2] flex items-center justify-between text-xs text-[#8A8478]">
