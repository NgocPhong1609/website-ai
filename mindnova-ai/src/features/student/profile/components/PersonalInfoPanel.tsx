    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="border-b border-[#FAF7F2] pb-4 flex items-center justify-between">
                ...
                <div className="hidden sm:flex items-center gap-2 px-3 py-1 rounded-xl bg-[#F8FAFC] border border-[#FAF7F2] text-xs font-medium text-[#8A8478]">
            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-end gap-3 pt-2">
                    <button
                        ...
                        disabled={!isDirty}
                        className="px-5 py-2.5 rounded-xl text-xs sm:text-sm font-medium text-[#8A8478] hover:text-[#2C3039] border border-[#FAF7F2] bg-white hover:bg-[#F4F5FB] disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 cursor-pointer shadow-2xs flex items-center justify-center gap-1.5"
                    >
                        <span></span>
