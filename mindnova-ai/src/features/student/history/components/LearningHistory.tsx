...
export function LearningHistory() {
    ...
    const renderDetailedItem = (item: HistoryTimelineItem, idx: number) => {
        if (item.type === "quiz" || (item.score_text && !item.shareable)) {
            return (
                <div key={item.id || idx} className="bg-white border border-[#FAF7F2] rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs hover:shadow-sm transition-all duration-200 hover:border-[#FAF7F2] group">
                    ...
                    <div className="flex items-center gap-5 justify-between sm:justify-end pt-3 sm:pt-0 border-t sm:border-0 border-[#F0F0F8]">
                        ...
                        <Link href={item.action_url || "/practice/quiz/result"} className="text-decoration-none shrink-0">
                            <button type="button" className="px-3.5 py-2 rounded-xl bg-[#F8FAFC] border border-[#FAF7F2] text-[#C0392B] font-medium text-xs hover:bg-[#FAF7F2] hover:border-[#C0392B]/25 transition-all flex items-center gap-1 shadow-2xs cursor-pointer">
        ...
        if (item.type === "milestone" || item.duration_tag) {
            return (
                <div key={item.id || idx} className="bg-white border border-[#FAF7F2] rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs hover:shadow-sm transition-all duration-200 hover:border-[#C0392B]/30 group">
                    <div className="flex items-center gap-4">
                    ...
                    <div className="shrink-0 flex items-center justify-between sm:justify-end gap-3 pt-3 sm:pt-0 border-t sm:border-0 border-[#F0F0F8]">
                        {item.duration_tag && (
                            <span className="flex items-center gap-1.5 text-xs font-normal text-[#8A8478] bg-[#F8FAFC] px-3 py-1.5 rounded-xl border border-[#FAF7F2]">
        ...
        return (
            <div key={item.id || idx} className="bg-white border border-[#FAF7F2] rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 shadow-2xs hover:shadow-sm transition-all duration-200 hover:border-[#2C3039]/30 group">
                <div className="flex items-center gap-4">
                ...
                <div className="shrink-0 sm:w-44 flex flex-col sm:items-end gap-1.5 pt-3 sm:pt-0 border-t sm:border-0 border-[#F0F0F8]">
                    ...
                    <div className="w-full h-2 bg-[#F4F5FC] rounded-full overflow-hidden p-0.5 border border-[#FAF7F2]">
                        <div
    ...
    return (
        <div className="p-6 md:p-8 max-w-[1400px] mx-auto min-h-full flex flex-col gap-7">
            ...
            <section className="relative overflow-hidden rounded-2xl bg-[#FEFCF9] border border-[#FAF7F2] p-6 sm:p-8 shadow-[0_8px_30px_rgba(192,57,43,0.07)] transition-all duration-300 hover:shadow-[0_12px_36px_rgba(192,57,43,0.12)]">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div className="space-y-3 max-w-2xl">
                        ...
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/95 backdrop-blur-md border border-[#FAF7F2] text-xs font-medium text-[#C0392B] shadow-2xs">
                    ...
                    <div className="group shrink-0 bg-white/95 backdrop-blur-md rounded-2xl p-5 border border-[#FAF7F2] flex flex-col justify-center min-w-[320px] sm:min-w-[370px] shadow-2xs hover:border-[#FAF7F2] transition-all duration-300">
                        ...
                        <div className="w-full h-2 bg-[#FAF7F2] rounded-full mt-2.5 overflow-hidden p-0.5 border border-[#FAF7F2]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                {/* Total Lessons */}
                <div className="bg-white border border-[#FAF7F2] rounded-2xl p-5 shadow-2xs hover:shadow-sm transition-all duration-300 flex flex-col justify-between gap-3.5 group hover:border-[#C0392B]/30">
                ...
                {/* Avg Quiz Score */}
                <div className="bg-white border border-[#FAF7F2] rounded-2xl p-5 shadow-2xs hover:shadow-sm transition-all duration-300 flex flex-col justify-between gap-3.5 group hover:border-[#2C3039]/30">
                    <div className="flex items-center justify-between">
                ...
                {/* Study Hours */}
                <div className="bg-white border border-[#FAF7F2] rounded-2xl p-5 shadow-2xs hover:shadow-sm transition-all duration-300 flex flex-col justify-between gap-3.5 group hover:border-[#0284C7]/30">
                    <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-baseline justify-between gap-2">
                        ...
                        <span className="text-[11px] font-normal text-[#8A8478] bg-[#F8FAFC] px-2.5 py-0.5 rounded-lg border border-[#FAF7F2] whitespace-nowrap">
                ...
                {/* AI Proficiency */}
                <div className="bg-white border border-[#FAF7F2] rounded-2xl p-5 shadow-2xs hover:shadow-sm transition-all duration-300 flex flex-col justify-between gap-3.5 group hover:border-[#9333EA]/30">
                    <div className="flex items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white p-4 sm:px-6 sm:py-4 rounded-2xl border border-[#FAF7F2] shadow-2xs">
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    <button
                        ...
                        className={`px-3.5 py-1.5 rounded-xl text-xs transition-all duration-150 cursor-pointer ${filterType === "all"
                            ? "bg-[#C0392B] text-white font-medium shadow-2xs"
                            : "bg-[#F8FAFC] text-[#8A8478] border border-[#FAF7F2] hover:text-[#2C3039] hover:bg-white font-normal"
                            }`}
                    >
                        Tất cả
                    </button>
                    ...
                    <button
                        ...
                        className={`px-3.5 py-1.5 rounded-xl text-xs transition-all duration-150 cursor-pointer ${filterType === "quiz"
                            ? "bg-[#C0392B] text-white font-medium shadow-2xs"
                            : "bg-[#F8FAFC] text-[#8A8478] border border-[#FAF7F2] hover:text-[#2C3039] hover:bg-white font-normal"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-3.5 py-1.5 rounded-xl text-xs transition-all duration-150 cursor-pointer ${filterType === "milestone"
                            ? "bg-[#C0392B] text-white font-medium shadow-2xs"
                            : "bg-[#F8FAFC] text-[#8A8478] border border-[#FAF7F2] hover:text-[#2C3039] hover:bg-white font-normal"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`px-3.5 py-1.5 rounded-xl text-xs transition-all duration-150 cursor-pointer ${filterType === "lesson"
                            ? "bg-[#C0392B] text-white font-medium shadow-2xs"
                            : "bg-[#F8FAFC] text-[#8A8478] border border-[#FAF7F2] hover:text-[#2C3039] hover:bg-white font-normal"
                            }`}
                    >
                ...
                <button
                    ...
                    className={`flex items-center justify-center gap-2 px-4 py-2 rounded-xl text-xs font-medium shadow-2xs transition-all duration-200 cursor-pointer shrink-0 ${isExporting
                    ...
                    return (
                        <div key={group.id || groupIndex} className="space-y-3.5">
                            <div className="flex items-center gap-3 pl-1">
                                <div className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 shadow-2xs ${group.icon_type === "calendar" ? "bg-[#FAF7F2] text-[#C0392B] border border-[#C0392B]/15" :
                                    group.icon_type === "calendar_light" ? "border border-[#FAF7F2] bg-[#F8FAFC] text-[#8A8478]" :
                                        "border border-[#FAF7F2] bg-[#F8FAFC] text-[#8A8478]"
                                    }`}>
                            ...
                            <div className="flex flex-col gap-3.5 pl-3 sm:pl-5 border-l-2 border-[#EAECEE] ml-4">
                                {group.is_compact ? (
                                    ...
                                    filteredItems.map((item, itemIdx) => (
                                        <div key={item.id || itemIdx} className="bg-white/90 border border-[#FAF7F2] rounded-2xl p-4 flex items-center justify-between gap-4 hover:bg-white transition-all duration-150 shadow-2xs hover:border-[#FAF7F2]">
                                            <div className="flex items-center gap-3.5 min-w-0">
                                                <div className="w-10 h-10 rounded-xl bg-[#F8FAFC] border border-[#FAF7F2] text-[#8A8478] flex items-center justify-center shrink-0 shadow-2xs">
                                            ...
                                            <span className={`text-[11px] font-medium px-2.5 py-1 rounded-lg shrink-0 border ${item.badge_color === "indigo" ? "text-[#C0392B] bg-[#FAF7F2] border-[#C0392B]/15" : "text-[#2C3039] bg-[#EAF8F5] border-[#2C3039]/15"
                                                }`}>
                    ...
                    <div className="pt-2 flex flex-col items-center justify-center pb-6 gap-3">
                        <div className="flex items-center gap-2">
                            <button
                                ...
                                disabled={page <= 1}
                                className="px-4 py-2 rounded-xl bg-white border border-[#FAF7F2] text-xs font-medium text-[#C0392B] hover:bg-[#FAF7F2] hover:border-[#C0392B]/30 transition-all shadow-2xs cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                            >
                                ← Trước
                            </button>
                            ...
                            <div className="flex items-center gap-1">
                                {Array.from({ length: totalPages }, (_, i) => i + 1).map((pageNum) => (
                                    <button
                                        ...
                                        className={`w-9 h-9 rounded-xl text-xs font-medium transition-all cursor-pointer ${pageNum === page
                                            ? "bg-[#C0392B] text-white shadow-2xs"
                                            : "bg-white border border-[#FAF7F2] text-[#C0392B] hover:bg-[#FAF7F2] hover:border-[#C0392B]/30"
                                            }`}
                                    >
                                        {pageNum}
                                    </button>
