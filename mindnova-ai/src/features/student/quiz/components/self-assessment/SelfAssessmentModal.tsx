...
export function SelfAssessmentModal({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
            <div className="bg-white rounded-3xl border border-[#FAF7F2] shadow-2xl max-w-3xl w-full max-h-[90vh] flex flex-col overflow-hidden relative transition-all">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-[#F0F2F8] from-[#EEF2FF] to-[#EAF8F5]">
                    ...
                    <button
                        onClick={onClose}
                        className="w-8 h-8 rounded-full bg-white border border-[#FAF7F2] flex items-center justify-center text-[#8A8478] hover:bg-gray-100 transition-colors"
                    >
                    ...
                    {step === "intro" && (
                        <div className="space-y-6 text-center py-4">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left max-w-xl mx-auto">
                                <div className="p-3.5 rounded-xl bg-[#F8FAFC] border border-[#FAF7F2]">
                                            ...
                                            {q.options.map((opt) => {
                                                ...
                                                return (
                                                    <div
                                                        ...
                                                        className={`p-4 rounded-xl border text-xs sm:text-sm cursor-pointer transition-all flex items-center justify-between ${isSelected
                                                            ? "bg-[#FAF7F2] border-[#C0392B] text-[#2C3039] font-semibold ring-1 ring-[#C0392B]"
                                                            : "bg-white border-[#FAF7F2] text-gray-700 hover:bg-[#FEFCF9]"
                                                            }`}
                                                    >
                                                        <span className="leading-relaxed">{opt.content}</span>
                                                        <div className={`w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ${isSelected ? "border-[#C0392B] bg-[#C0392B]" : "border-gray-300"
                                                            }`}>
                            ...
                            <div className="space-y-3 pt-2">
                                ...
                                <div className="space-y-2.5 max-h-60 overflow-y-auto pr-1">
                                    {results.question_details?.map((det, idx) => (
                                        <div
                                            key={det.id}
                                            className={`p-3.5 rounded-xl border text-xs space-y-1.5 ${det.is_correct ? "bg-[#E8F8F0] border-[#E8F8F0] text-[#2C3039]" : "bg-[#FADBD8] border-[#C0392B] text-[#C0392B]"
                                                }`}
                                        >
                                            <div className="flex items-start justify-between gap-2">
                                                ...
                                                <span className={`px-2 py-0.5 rounded text-[10px] font-bold shrink-0 ${det.is_correct ? "bg-[#27AE60] text-white" : "bg-[#C0392B] text-white"
                                                    }`}>
