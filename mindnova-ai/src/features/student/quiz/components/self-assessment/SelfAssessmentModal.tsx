...
export function SelfAssessmentModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-fadeIn">
      <div className="bg-white rounded-3xl border border-[#E5E7EB] shadow-2xl max-w-3xl w-full max-h-[90vh] flex flex-col overflow-hidden relative transition-all">

        {/* Modal Header */}
        <div className="flex items-center justify-between px-6 py-4 border-b border-[#F0F2F8] bg-gradient-to-r from-[#EEF2FF] to-[#EAF8F5]">
        ...
        <div className="p-6 overflow-y-auto flex-1">
          ...
          {step === "intro" && (
            <div className="space-y-6 text-center py-4">
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#4648D4] via-[#5052EE] to-[#0D9488] text-white flex items-center justify-center text-3xl mx-auto shadow-md">
                🧠
              </div>
              ...
              <div className="space-y-2 max-w-lg mx-auto">
                ...
                <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                  Gia sư AI Nova sẽ tự động đọc **toàn bộ nội dung các bài học** của khóa <strong className="text-[#5052EE]">{courseTitle}</strong> để tạo ngẫu nhiên bộ **10 câu hỏi trắc nghiệm** phù hợp với năng lực của bạn.
                </p>
              </div>

              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left max-w-xl mx-auto">
                <div className="p-3.5 rounded-xl bg-[#F8FAFC] border border-[#EAEAF4]">
                  <span className="text-xs text-gray-500 font-medium block mb-0.5">Số lượng câu hỏi</span>
                  <span className="text-sm font-bold text-[#1A1A2E]">10 Câu Trắc Nghiệm</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F8FAFC] border border-[#EAEAF4]">
                  <span className="text-xs text-gray-500 font-medium block mb-0.5">Tín chỉ học tập</span>
                  <span className="text-sm font-bold text-[#0D9488]">0 Tín (Tự luyện)</span>
                </div>
                <div className="p-3.5 rounded-xl bg-[#F8FAFC] border border-[#EAEAF4]">
                  <span className="text-xs text-gray-500 font-medium block mb-0.5">Thời gian đề xuất</span>
                  <span className="text-sm font-bold text-[#5052EE]">15 Phút</span>
                </div>
              </div>
              ...
              <div className="pt-4 flex items-center justify-center gap-3">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-5 py-3 rounded-xl border border-gray-300 text-xs sm:text-sm font-semibold text-gray-600 hover:bg-gray-50 transition-colors"
                >
                  Hủy bỏ
                </button>
                <button
                  ...
                  className="px-7 py-3 rounded-xl bg-gradient-to-r from-[#4648D4] via-[#5052EE] to-[#0D9488] text-white text-xs sm:text-sm font-bold shadow-md hover:opacity-95 transition-all flex items-center gap-2 cursor-pointer"
                >
          ...
          {step === "generating" && (
            <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
              <div className="relative w-16 h-16">
                <div className="w-16 h-16 rounded-full border-4 border-[#EEF2FF] border-t-[#5052EE] animate-spin" />
                <div className="absolute inset-0 flex items-center justify-center text-xl">🧠</div>
              </div>
              <div className="space-y-1 max-w-md">
                <h4 className="text-base font-bold text-[#1A1A2E] animate-pulse">
          ...
          {step === "testing" && assessment && (
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between border-b border-gray-100 pb-3">
                <div>
                  <span className="text-xs font-bold text-[#5052EE] uppercase tracking-wider">
                ...
                <div className="w-36 h-2 bg-gray-100 rounded-full overflow-hidden">
                  <div
                    className="h-full bg-[#5052EE] transition-all duration-300"
              ...
              {(() => {
                ...
                return (
                  <div className="space-y-4">
                    <h4 className="text-sm sm:text-base font-bold text-[#1A1A2E] leading-relaxed">
                      {q.order}. {q.content}
                    </h4>
                        ...
                        return (
                          <div
                            ...
                            className={`p-4 rounded-xl border text-xs sm:text-sm cursor-pointer transition-all flex items-center justify-between ${
                              isSelected
                                ? "bg-[#EEF2FF] border-[#5052EE] text-[#1E1B4B] font-semibold ring-1 ring-[#5052EE]"
                          ...
                          >
                            ...
                            <div className={`w-4 h-4 rounded-full border flex items-center justify-center shrink-0 ${
                              isSelected ? "border-[#5052EE] bg-[#5052EE]" : "border-gray-300"
                            }`}>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                <button
                  ...
                  className="px-4 py-2.5 rounded-xl border border-gray-300 text-xs font-semibold text-gray-600 hover:bg-gray-50 disabled:opacity-40"
                >
                  ← Câu trước
                </button>
                ...
                {currentQuestionIndex < assessment.questions.length - 1 ? (
                  <button
                    type="button"
                    onClick={() => setCurrentQuestionIndex((prev) => prev + 1)}
                    className="px-5 py-2.5 rounded-xl bg-[#5052EE] text-white text-xs font-semibold hover:bg-[#4338CA] transition-colors"
                  >
                    Câu tiếp theo →
                  </button>
                ) : (
                  <button
                    ...
                    className="px-6 py-2.5 rounded-xl bg-[#0D9488] text-white text-xs font-bold hover:bg-[#0F766E] shadow-sm transition-colors flex items-center gap-1.5"
                  >
          ...
          {step === "submitting" && (
            <div className="py-12 flex flex-col items-center justify-center text-center space-y-4">
              <div className="w-12 h-12 rounded-full border-4 border-[#CCFBF1] border-t-[#0D9488] animate-spin" />
              <h4 className="text-base font-bold text-[#1A1A2E] animate-pulse">
          ...
          {step === "results" && results && (
            <div className="space-y-6">
              {/* Score Header Card */}
              <div className="p-6 rounded-2xl bg-gradient-to-r from-[#EEF2FF] via-[#F6F6FB] to-[#EAF8F5] border border-[#5052EE]/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-left">
                <div>
                  <span className="text-xs font-bold text-[#0D9488] bg-white px-3 py-1 rounded-full border border-[#0D9488]/20 shadow-2xs inline-block mb-1.5">
                    🧠 Kết quả tự đánh giá bằng AI
                  </span>
                  <h4 className="text-xl font-bold text-[#1A1A2E]">
                    Bạn đạt: <span className="text-[#5052EE]">{results.score_text}</span> ({results.score_percentage}%)
                  </h4>
                ...
                <div className="shrink-0 w-20 h-20 rounded-2xl bg-white border border-[#5052EE]/30 flex flex-col items-center justify-center shadow-sm">
                  <span className="text-2xl font-bold text-[#5052EE]">{results.score_percentage}%</span>
                  <span className="text-[10px] text-gray-400 font-semibold uppercase">{results.passed ? "Đạt Chuẩn" : "Cần Ôn Tập"}</span>
                </div>
              </div>

              {/* AI Tutor Insight */}
              <div className="p-4.5 rounded-2xl bg-[#EEF2FF] border border-[#C7D2FE] space-y-2">
                  ...
                  {results.question_details?.map((det, idx) => (
                    <div
                      ...
                      className={`p-3.5 rounded-xl border text-xs space-y-1.5 ${
                        det.is_correct ? "bg-emerald-50/60 border-emerald-200 text-emerald-900" : "bg-rose-50/60 border-rose-200 text-rose-900"
                      }`}
                    >
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <span className={`px-2 py-0.5 rounded text-[10px] font-bold shrink-0 ${
                          det.is_correct ? "bg-emerald-100 text-emerald-800" : "bg-rose-100 text-rose-800"
                        }`}>
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                ...
                <button
                  type="button"
                  onClick={onClose}
                  className="px-6 py-2.5 rounded-xl bg-[#5052EE] text-white text-xs font-bold hover:bg-[#4338CA] transition-colors"
                >
                  Đóng
                </button>
              </div>
