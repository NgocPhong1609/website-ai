...
export function QuizStartContent() {
    ...
    return (
        <div className="p-6 md:p-8 max-w-[1400px] mx-auto min-h-full flex flex-col gap-8 bg-[#F8F9FC]">
            ...
            {/* Hero Banner */}
            <section className="relative overflow-hidden rounded-2xl bg-[#FEFCF9] border border-[#FAF7F2] p-6 sm:p-8 shadow-sm">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6">
                    <div className="space-y-3 max-w-2xl">
                        ...
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-[#FAF7F2] text-xs font-semibold text-[#C0392B] shadow-sm">
                    ...
                    {defaultModules.map((mod, index) => {
                        ...
                        return (
                            <div
                                ...
                                className={`p-5 rounded-2xl border cursor-pointer transition-all duration-300 flex flex-col justify-between relative overflow-hidden ${isSelected
                                    ? "bg-white border-[#C0392B] shadow-md ring-2 ring-[#C0392B] -translate-y-1"
                                    : isSpecialAi
                                        ? " from-[#F5F3FF] to-white border-[#C7D2FE] hover:border-[#C0392B]"
                                        : "bg-white border-[#FAF7F2] hover:shadow-sm"
                                    }`}
                            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                ...
                <div className="lg:col-span-8 flex flex-col gap-6 w-full">
                    {isAiSelected ? (
                        <div className="bg-white rounded-2xl p-7 border border-[#FAF7F2] shadow-sm space-y-6">
                            {!generatedQuiz ? (
                                <>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                        <div className="p-4 rounded-xl bg-[#F8FAFC] border border-[#FAF7F2]">
                        ...
                        /* Module có sẵn */
                        <div className="bg-white rounded-2xl p-7 border border-[#FAF7F2] shadow-sm space-y-7">
                            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-5">
                                <div className="space-y-2 max-w-xl">
                    ...
                    {/* Hướng dẫn chung */}
                    <div className="bg-white rounded-2xl p-7 border border-[#FAF7F2] shadow-sm space-y-4">
                ...
                <div className="lg:col-span-4 flex flex-col gap-6 w-full">
                    <div className="bg-white rounded-2xl p-6 border border-[#FAF7F2] shadow-sm space-y-5">
                        ...
                        {myHistoryQuizzes.length === 0 ? (
                            ...
                            <div className="flex flex-col gap-3 max-h-[480px] overflow-y-auto pr-1">
                                {myHistoryQuizzes.map((quiz) => (
                                    <div
                                        key={quiz.id}
                                        className="p-3.5 rounded-xl border border-[#FAF7F2] bg-[#F8FAFC] hover:border-[#C0392B]/40 hover:bg-white transition-all flex flex-col gap-2.5 group relative"
                                    >
            ...
            {reviewingQuiz && (
                <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
                    <div className="bg-white rounded-3xl max-w-3xl w-full max-h-[90vh] flex flex-col shadow-2xl border border-[#FAF7F2] overflow-hidden animate-in fade-in zoom-in duration-200">
                        ...
                        <div className="p-6 border-b border-[#F0F2F8] flex items-center justify-between from-[#EEF2FF] to-white">
                            ...
                            <button
                                ...
                                className="w-9 h-9 rounded-full bg-white border border-[#FAF7F2] flex items-center justify-center text-sm font-bold text-[#8A8478] hover:bg-[#FAF7F2] hover:text-[#C0392B] transition-all cursor-pointer"
                            >
                        ...
                        <div className="p-6 overflow-y-auto space-y-6 flex-1 bg-[#F8FAFC]">
                            {reviewingQuiz.questions_data?.map((q: any, idx: number) => {
                                ...
                                return (
                                    <div key={q.id || idx} className="p-5 rounded-2xl bg-white border border-[#FAF7F2] shadow-xs space-y-3.5">
                                        ...
                                        {isEssayOrFill ? (
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                                                {q.options?.map((opt: string, optIdx: number) => {
                                                    ...
                                                    let optStyle = "bg-[#F8FAFC] border-[#FAF7F2] text-[#2C3039]";
                                                    if (isRightKey) {
