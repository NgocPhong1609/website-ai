...
export function QuizResultContent() {
 ...
 return (
 <div key={q.id || idx} className="p-6 rounded-2xl bg-white border border-[#E8E2D9] shadow-xs space-y-4">
 ...
 <div className="bg-white w-full max-w-4xl rounded-3xl border border-[#E8E2D9] shadow-2xl max-h-[90vh] flex flex-col overflow-hidden animate-scaleUp">
 
 <div className="p-6 from-[#EEF2FF] via-[#F3F4FC] to-[#EAF8F5] border-b border-[#E8E2D9] flex items-center justify-between shrink-0">
 ...
 className="w-10 h-10 rounded-xl bg-white text-[#8A8478] hover:text-[#2C3039] hover:bg-[#F0F2F8] border border-[#E8E2D9] flex items-center justify-center font-semibold text-lg transition-colors cursor-pointer"
 title="Đóng cửa sổ"
 >
 ...
 <div className="flex flex-wrap gap-2 pb-2 border-b border-[#E8E2D9]">
 <button 
 onClick={() => setSelectedFilter("all")}
 className={`px-3.5 py-1.5 rounded-xl text-xs font-semibold transition-colors cursor-pointer ${selectedFilter === "all" ? "bg-[#C0392B] text-white" : "bg-white text-[#8A8478] border border-[#E8E2D9]"}`}
 >
 ...
 <div key={item.question_id} className="bg-white rounded-2xl p-5 border border-[#E8E2D9] shadow-2xs space-y-4 hover:border-[#C0392B]/30 transition-colors">
 ...
 <div className="p-4 rounded-xl bg-[#F8FAFC] border border-[#E8E2D9] space-y-1">
 ...
 <div className="pt-2 border-t border-[#E8E2D9] space-y-1">
 ...
 <div className="p-4 bg-white border-t border-[#E8E2D9] flex items-center justify-end gap-3 shrink-0">
 <button 
 type="button"
 onClick={() => setIsReviewModalOpen(false)}
 ...
 <div className="md:col-span-7 from-white via-[#FAFBFF] to-[#F3F4FC] rounded-2xl border border-[#E8E2D9] shadow-2xs relative overflow-hidden p-8 flex flex-col items-center justify-center text-center transition-all duration-300 hover:shadow-sm">
 ...
 <div className="relative z-10 grid grid-cols-2 gap-8 w-full max-w-xs mt-7 pt-5 border-t border-[#E8E2D9]">
 <div>
 ...
 <div className="border-l border-[#E8E2D9]">
 ...
 <div className="md:col-span-5 bg-white rounded-2xl border border-[#E8E2D9] shadow-2xs p-6 flex flex-col justify-between transition-all duration-300 hover:shadow-sm hover:border-[#C0392B]/30">
 ...
 {/* Topic Performance */}
 <div className="bg-white rounded-2xl border border-[#E8E2D9] shadow-2xs p-6 sm:p-7 transition-all duration-300 hover:shadow-sm">
 ...
 <div key={t.id || idx} className="p-4 rounded-xl bg-[#F8FAFC] border border-[#E8E2D9] hover:border-[#C0392B]/20 transition-colors space-y-2.5">
 ...
 className="bg-white rounded-2xl p-6 border border-[#E8E2D9] shadow-2xs transition-all duration-300 hover:shadow-md hover:border-[#C0392B]/50 hover:-translate-y-0.5 flex flex-col justify-between group cursor-pointer"
 >
 <div>
 ...
 <div className="h-full bg-white rounded-2xl p-6 border border-[#E8E2D9] shadow-2xs transition-all duration-300 hover:shadow-md hover:border-[#2C3039]/50 hover:-translate-y-0.5 flex flex-col justify-between group cursor-pointer">
 <div>
 ...
 <div className="h-full bg-white rounded-2xl p-6 border border-[#E8E2D9] shadow-2xs transition-all duration-300 hover:shadow-md hover:border-[#C0392B]/50 hover:-translate-y-0.5 flex flex-col justify-between group cursor-pointer">
 <div>
