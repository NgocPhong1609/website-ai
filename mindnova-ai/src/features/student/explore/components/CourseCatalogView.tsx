      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
        {courses.map((course) => {
          ...
          return (
            <div
              key={course.id}
              className="group flex flex-col bg-white rounded-2xl border border-[#FAF7F2] overflow-hidden shadow-sm hover:shadow-xl hover:border-[#C0392B]/40 transition-all duration-300 transform hover:-translate-y-1 justify-between h-full"
            >
              {/* Thumbnail */}
