...
function ArticleRenderer({
  ...
  if (!lesson.content) {
    return (
      <div className="w-full p-12 flex flex-col items-center justify-center text-gray-400 bg-[#FEFCF9] rounded-2xl border border-[#FAF7F2]">
        <></>
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {!completedRef.current && (
        <div className="flex items-center gap-3 p-3 rounded-xl bg-[#FEFCF9] border border-[#FAF7F2]">
          <></>
 ...
 bg-white rounded-2xl border border-[#FAF7F2] p-6 sm:p-8 shadow-sm
 ...
 [&_th]:bg-[#F5F0E8] [&_th]:border [&_th]:border-[#FAF7F2] [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:font-semibold [&_th]:text-sm
 [&_td]:border [&_td]:border-[#FAF7F2] [&_td]:px-3 [&_td]:py-2 [&_td]:text-sm
 [&_pre]:bg-[#1F2937] [&_pre]:text-gray-200 [&_pre]:rounded-xl [&_pre]:p-4 [&_pre]:overflow-x-auto [&_pre]:my-4
 [&_code]:font-mono [&_code]:text-sm
 [&_hr]:border-[#FAF7F2] [&_hr]:my-6
...
function QuizRenderer({
  ...
  if (loading) {
    return (
      <div className="w-full p-12 flex flex-col items-center justify-center bg-[#FEFCF9] rounded-2xl border border-[#FAF7F2]">
  ...
  if (phase === 'result' && quizResult) {
    ...
    return (
      <div className="w-full bg-white rounded-2xl border border-[#FAF7F2] shadow-sm p-8 flex flex-col items-center gap-6">
  ...
  return (
    <div className="w-full bg-white rounded-2xl border border-[#FAF7F2] shadow-sm overflow-hidden">
      {/* Quiz Header */}
      <div className="flex items-center justify-between px-6 py-4 bg-[#FEFCF9] border-b border-[#FAF7F2]">
        ...
        {((question as any).type === "essay" || !question.answers || question.answers.length === 0) ? (
          <div className="flex flex-col gap-3 mb-6">
            ...
            <textarea
              ...
              className="w-full p-4 rounded-xl border border-[#FAF7F2] text-sm text-[#2C3039] focus:border-[#C0392B] focus:outline-none bg-white font-medium shadow-2xs"
            />

            {answered && (
              <div className="p-5 rounded-2xl bg-[#FAF7F2] border border-[#FAF7F2] flex flex-col gap-4 text-xs animate-fadeIn mt-2 shadow-2xs">
                {essayResult[question.id] ? (
                  <div className="flex flex-col gap-3 p-4 rounded-xl bg-white border border-[#FAF7F2] shadow-2xs">
                    ...
                    <p className="text-[#8A8478] font-medium text-xs leading-relaxed bg-[#F5F0E8]/50 p-3 rounded-lg border border-[#FAF7F2]/60">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <p className="text-[#8A8478] font-medium leading-relaxed whitespace-pre-line bg-white p-4 rounded-xl border border-[#FAF7F2] shadow-2xs">
                    {(question as any).sample_answer || "Yêu cầu học viên phân tích đầy đủ các luận điểm chính trong bài học."}
                  </p>
                </div>

                {(question as any).rubric && (
                  <div className="flex flex-col gap-1.5 pt-2 border-t border-[#FAF7F2]">
          ...
          <div className="flex flex-col gap-3 mb-6">
            {question.answers.map((ans: any, idx: number) => {
              ...
              let ansStyle = "bg-white border-[#FAF7F2] hover:border-[#C0392B] hover:bg-[#FEFCF9]";
                    ...
                    isSelected && !answered ? "bg-[#C0392B] text-white border-[#C0392B]" :
                      answered && isSelected && answerResult ? "bg-[#059669] text-white border-[#059669]" :
                        answered && isSelected && !answerResult ? "bg-[#DC2626] text-white border-[#DC2626]" :
                          "bg-[#F5F0E8] text-[#8A8478] border-[#FAF7F2]"
                  )}>
                    {letter}
                  </span>
...
function LessonWorkspaceContent() {
  ...
  if (!parsedCourseId || parsedCourseId <= 0) {
    return (
      <div className="w-full h-screen flex flex-col items-center justify-center bg-[#FEFCF9] p-6">
        <div className="bg-white p-8 rounded-3xl shadow-sm max-w-md w-full text-center border border-[#FAF7F2]">
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white pb-24 relative">
      ...
      <header className="w-full bg-white border-b border-[#FAF7F2] px-6 py-4 sticky top-0 z-30 shadow-2xs">
        <div className="max-w-[1400px] mx-auto flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            <Link
              href={`/courses/detail?courseId=${parsedCourseId}`}
              className="w-9 h-9 rounded-xl bg-white border border-[#FAF7F2] hover:bg-[#FEFCF9] flex items-center justify-center text-[#8A8478] hover:text-[#2C3039] transition-colors shrink-0 text-decoration-none shadow-2xs"
      ...
      <div className="max-w-[1400px] w-full mx-auto p-6 md:p-8 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <main className="lg:col-span-8 flex flex-col gap-6 w-full min-w-0">
          ...
          <div className="bg-white rounded-2xl border border-[#FAF7F2] shadow-sm overflow-hidden">
            <div className="flex items-center border-b border-[#FAF7F2] px-6 gap-6 bg-white overflow-x-auto">
              <button
            ...
            <div className="p-6 sm:p-8">
              ...
              {activeTab === "ai_tips" && (
                <div className="flex flex-col gap-5">
                  <div className="p-4 rounded-xl bg-[#FEFCF9] border border-[#FAF7F2] flex items-center gap-4">
              ...
              {activeTab === "discussion" && (
                <div className="flex flex-col gap-6">
                  <form onSubmit={handlePostComment} className="flex flex-col gap-3 p-5 rounded-xl bg-[#FEFCF9] border border-[#FAF7F2]">
                    ...
                    <textarea
                      ...
                      className="w-full p-3.5 rounded-xl border border-[#FAF7F2] bg-white text-[#2C3039] text-sm placeholder:text-[#8A8478] focus:outline-none focus:border-[#C0392B] focus:ring-2 focus:ring-[#C0392B]/20 transition-all resize-none"
                    />
                      ...
                      apiDiscussions?.map((item) => (
                        <div key={item.id} className="flex flex-col gap-3">
                          ...
                          {editingDiscussionId === item.id ? (
                            <form onSubmit={(e) => handleEditDiscussionSubmit(e, item.id)} className="p-4 sm:p-5 rounded-xl border border-[#FAF7F2] bg-white flex flex-col gap-3">
                              <textarea
      ...
      <footer className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-[#FAF7F2] px-6 py-3.5 z-40 shadow-sm">
        <div className="max-w-[1400px] mx-auto flex flex-wrap items-center justify-between gap-4">
          <button
            onClick={handleGoPrevious}
            disabled={!hasPrevious}
            className="flex items-center gap-2 px-5 py-2 rounded-xl border border-[#FAF7F2] bg-white hover:bg-[#FEFCF9] text-[#8A8478] font-semibold text-xs sm:text-sm transition-all disabled:opacity-40 disabled:pointer-events-none cursor-pointer shadow-sm"
          >
            <></>
            <span>Bài trước</span>
          </button>
          ...
          <div className="flex flex-col sm:flex-row items-end sm:items-center gap-3">
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-4 sm:px-5 py-2 rounded-xl text-xs sm:text-sm font-bold text-[#2C3039] bg-[#FEFCF9] border border-[#FAF7F2] hover:bg-[#F5F0E8] transition-all cursor-pointer shadow-2xs"
              title={
