...
export function CustomVideoPlayer({
  ...
  if (loading) {
    return (
      <div className="relative w-full aspect-video bg-[#0f172a] rounded-2xl overflow-hidden flex items-center justify-center border border-[#FAF7F2]">
  ...
  if (error) {
    return (
      <div className="relative w-full aspect-video bg-[#FEFCF9] rounded-2xl overflow-hidden flex items-center justify-center border border-[#FAF7F2]">
  ...
  if (
    ...
    return (
      <div className="relative w-full aspect-video bg-black rounded-2xl overflow-hidden shadow-sm border border-[#FAF7F2]">
        <iframe
          src={embedUrl}
          title={lesson.title}
  ...
  return (
    <div
      ...
      className={twMerge(
        ...
        isFullscreen ? "rounded-none fixed inset-0 z-[9999]" : "rounded-2xl border border-[#FAF7F2]"
      )}
      ...
      >
        ...
        <div className="flex items-center justify-between text-white mt-1">
          ...
          <div className="flex items-center gap-3 sm:gap-5">
            <button onClick={togglePlay} className="hover:text-[#FAF7F2] transition-colors focus:outline-none">
              {isPlaying ? <PauseIcon /> : <PlayIcon />}
            </button>

            <button onClick={() => skipTime(-10)} className="hover:text-[#FAF7F2] transition-colors focus:outline-none hidden sm:block" title="Tua lại 10s">
              <Rewind10Icon />
            </button>
            <button onClick={() => skipTime(10)} className="hover:text-[#FAF7F2] transition-colors focus:outline-none hidden sm:block" title="Tua đi 10s">
              <Forward10Icon />
            </button>

            <div className="flex items-center gap-2 group/volume relative">
              <button onClick={toggleMute} className="hover:text-[#FAF7F2] transition-colors focus:outline-none">
          ...
          <div className="flex items-center gap-3 sm:gap-5 relative">
            ...
            {/* Fullscreen */}
            <button onClick={toggleFullscreen} className="hover:text-[#FAF7F2] transition-colors focus:outline-none">
