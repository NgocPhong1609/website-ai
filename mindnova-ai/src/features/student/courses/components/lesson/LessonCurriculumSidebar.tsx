export function LessonCurriculumSidebar() {
    return (
        <aside className="w-[300px] shrink-0 border-r border-[#FAF7F2] bg-white h-full overflow-y-auto hidden lg:block">
            <div className="p-6">
                ...
                <div className="mb-6">
                    <div className="flex justify-between items-center mb-2">
                        <div className="h-1.5 flex-1 bg-[#F5F0E8] rounded-full overflow-hidden mr-3 border border-[#FAF7F2]">
                ...
                <div className="flex flex-col space-y-2">
                    {/* Item 1 - Completed */}
                    <div className="flex items-start gap-3 p-3 rounded-xl hover:bg-[#FAF7F2] cursor-pointer transition-colors border border-transparent hover:border-[#FAF7F2]">
