        ...
        <div className="flex-1 overflow-y-auto bg-white relative">
            <div className="p-8 max-w-4xl mx-auto pb-32">
                ...
                <div className="flex flex-wrap items-center gap-3 mb-6">
                    ...
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#FAF7F2] text-[#C0392B] border border-[#FAF7F2]">
                        Intermediate
                    </span>
                    <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-[#FEFCF9] text-[#8A8478] border border-[#FAF7F2]">
                        25 Phút
                    </span>
                </div>
                ...
                {/* Code Block */}
                <div className="bg-[#FEFCF9] rounded-xl overflow-hidden shadow-sm border border-[#FAF7F2]">
                    <div className="flex items-center justify-between px-4 py-2.5 bg-[#F5F0E8] border-b border-[#FAF7F2]">
                        <span className="text-xs text-[#8A8478] font-mono">app/api/route.ts</span>
                        <button type="button" className="text-[#8A8478] hover:text-[#2C3039] transition-colors font-bold text-[10px] uppercase cursor-pointer border border-[#FAF7F2] px-2 py-0.5 rounded bg-white" title="Copy code">
                            Copy
                        </button>
                    </div>
