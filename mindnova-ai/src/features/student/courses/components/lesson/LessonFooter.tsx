    ...
    return (
        <div className="absolute bottom-0 left-0 right-0 bg-white border-t border-[#F0F0F8] px-8 py-4 z-10">
            <div className="max-w-4xl mx-auto flex items-center justify-between">
                ...
                <button className="flex items-center gap-2 text-sm font-semibold text-[#C0392B] hover:text-[#C0392B] transition-colors ml-4 mr-auto border-l border-[#FAF7F2] pl-4">
                    <></>
                    Mark as Completed
                </button>
                ...
                <div className="flex items-center gap-3">
                    <button className="px-5 py-2.5 rounded-xl text-sm font-semibold text-[#C0392B] border border-[#FAF7F2] hover:bg-[#FAF7F2] transition-colors">
                        Take Quiz
                    </button>
