            ...
            <section className="relative overflow-hidden rounded-2xl bg-[#FEFCF9] border border-[#FAF7F2] p-6 sm:p-7 transition-all duration-300 w-full">
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-6 w-full">
                    <div className="space-y-3 max-w-xl">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FAF7F2] border border-[#FAF7F2] text-xs font-semibold text-[#C0392B]">
                    ...
                    <div className="group shrink-0 bg-white rounded-2xl p-5 border border-[#FAF7F2] flex flex-col justify-center min-w-[320px] sm:min-w-[380px] hover:border-[#B8B0A3] transition-all duration-300">
                        ...
                        <div className="w-full h-1.5 bg-[#F5F0E8] rounded-full mt-2 overflow-hidden p-0 border border-[#FAF7F2]">
                            <div
            ...
            <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
                <div className="relative flex-1 max-w-md">
                    <input
                        ...
                        className="w-full pl-4 pr-9 py-2.5 rounded-xl text-xs sm:text-sm font-normal text-[#2C3039] bg-white border border-[#FAF7F2] placeholder:text-[#B8B0A3] focus:outline-none focus:ring-2 focus:ring-[#FAF7F2] focus:border-[#B8B0A3] transition-all duration-200"
                    />
                    {searchQuery && (
                        <button
                            type="button"
                            ...
                            <button
                                ...
                                className={twMerge(
                                    ...
                                    isActive
                                        ...
                                        : "bg-white text-[#8A8478] font-medium hover:text-[#2C3039] hover:bg-[#F5F0E8] border border-[#FAF7F2]"
                                )}
                            >
                                <span>{tab.label}</span>
                                <span
                                    className={twMerge(
                                        ...
                                        isActive
                                            ...
                                            : "bg-[#F5F0E8] text-[#8A8478] group-hover:bg-[#FAF7F2] group-hover:text-[#2C3039]"
                                    )}
                                >
                                    {count}
                                </span>
