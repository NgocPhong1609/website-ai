    ...
    <div className="flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-12">
        {filteredCourses.length > 0 ? (
          ...
          <div className="col-span-full py-12 px-6 text-center bg-white rounded-xl border border-[#FAF7F2] flex flex-col items-center justify-center shadow-sm">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="px-5 py-2.5 rounded-lg bg-white border border-[#FAF7F2] text-[#2C3039] text-xs sm:text-sm font-semibold hover:bg-[#F5F0E8] transition-all"
              >
                Đặt lại bộ lọc
              </button>
