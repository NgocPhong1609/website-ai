        ...
        <div className="max-w-[1200px] mx-auto w-full p-8 lg:p-10">
            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-6">
                <div>
                    ...
                    <h1 className="text-3xl font-bold text-[#2C3039] leading-tight mb-2">
                ...
                {/* Status Badge */}
                <div className="flex items-center gap-2 bg-[#F0F0FF] text-[#C0392B] px-4 py-2.5 rounded-xl text-[14px] font-bold shrink-0">
            ...
            <div className="flex flex-col lg:flex-row gap-8 items-start">
                ...
                <div className="flex-1 flex flex-col gap-6 w-full">
                    ...
                    <div className="bg-white border border-[#FAF7F2] rounded-2xl p-6 shadow-sm">
                    ...
                    {/* Editor Card */}
                    <div className="bg-white border border-[#FAF7F2] rounded-2xl flex flex-col shadow-sm overflow-hidden">
                        <div className="bg-[#FBFBFC] border-b border-[#FAF7F2] px-4 py-3 flex items-center justify-between">
                        ...
                        <textarea
                            className="w-full p-6 min-h-[300px] text-[15px] text-[#2C3039] placeholder-[#A0A0C0] outline-none resize-y"
                            placeholder="Begin typing your response here... Use professional academic tone."
                        ></textarea>
                    </div>

                    {/* File Upload Card */}
                    <div className="bg-white border-2 border-dashed border-[#D0D0E0] rounded-2xl p-10 flex flex-col items-center justify-center text-center shadow-sm hover:border-[#FAF7F2] transition-colors bg-[#FBFBFC]">
                        <div className="w-12 h-12 rounded-2xl bg-[#F0F0FF] text-[#C0392B] flex items-center justify-center mb-4">
                            <UploadCloudIcon className="w-6 h-6" />
                        </div>
                        <h3 className="text-[16px] font-bold text-[#2C3039] mb-2">Drag &amp; Drop Supplementary Files</h3>
                        <p className="text-[13px] text-[#8A8478] mb-6 max-w-sm">
                            PDF, DOCX, or ZIP (Max 25MB). You can also include code repositories.
                        </p>
                        <button className="px-6 py-2.5 bg-white border border-[#FAF7F2] text-[#8A8478] font-bold text-[13px] rounded-xl hover:bg-[#F0F0F8] shadow-sm transition-colors">
                            Browse Files
                        </button>
                    </div>
                ...
                <div className="w-full lg:w-[320px] shrink-0 flex flex-col gap-6">
                    ...
                    <div className="bg-white border border-[#FAF7F2] rounded-2xl p-6 shadow-sm">
                        <div className="flex items-center gap-4 mb-6">
                            ...
                            <div>
                                <h3 className="text-[16px] font-bold text-[#2C3039]">AI Pre-Check</h3>
                                <p className="text-[9px] font-bold tracking-widest text-[#C0392B] uppercase mt-1">Powered by Nova Core v4</p>
                            </div>
                        </div>

                        <div className="mb-6">
                            <div className="flex items-center justify-between text-[12px] font-bold mb-2">
                                <span className="text-[#2C3039]">Requirement Matching</span>
                    ...
                    <div className="bg-white border border-[#FAF7F2] rounded-2xl p-6 shadow-sm">
                        <div className="flex items-center justify-between py-3 border-b border-[#FAF7F2]">
                            <span className="text-[13px] font-semibold text-[#8A8478]">Character Count</span>
                            <span className="text-[13px] font-bold text-[#2C3039]">0/8,000</span>
                        </div>
                        <div className="flex items-center justify-between py-3">
                            <span className="text-[13px] font-semibold text-[#8A8478]">Uploaded Files</span>
                    ...
                    {/* Promo Card */}
                    <div className=" from-[#1A1A2E] to-[#2B1B8A] rounded-2xl p-6 text-white overflow-hidden relative shadow-md">
                        {/* Abstract Graphic Background */}
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#FAF7F2] rounded-full blur-[60px] opacity-40 mix-blend-screen transform translate-x-1/2 -translate-y-1/2" />
