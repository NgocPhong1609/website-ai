...
export function AssignmentSubmission() {
 ...
 {/* File Upload Card */}
 <div className="bg-white border-2 border-dashed border-[#D0D0E0] rounded-2xl p-10 flex flex-col items-center justify-center text-center shadow-sm hover:border-[#E8E2D9] transition-colors bg-[#FBFBFC]">
