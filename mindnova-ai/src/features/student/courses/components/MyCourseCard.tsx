...
export function MyCourseCard({ course }: { course: MyCourse }) {
    ...
    const buttonStyle = isCompleted
        ? "bg-[#F5F0E8] text-[#2C3039] hover:bg-[#FAF7F2] border border-[#FAF7F2]"
        : isNotStarted
    ...
    return (
        <div className="group/card bg-white border border-[#FAF7F2] rounded-xl flex flex-col justify-between h-full hover:border-[#B8B0A3] transition-all duration-300 overflow-hidden">
            {/* Thumbnail Header */}
            <div className="relative h-44 w-full bg-[#2C3039] overflow-hidden shrink-0">
                ...
                {course.isAiRecommended && (
                    <div className="absolute top-3.5 right-3.5 flex items-center gap-1 px-2.5 py-1 rounded-full bg-white text-[#C0392B] text-[10px] font-bold border border-[#FAF7F2] z-10 uppercase tracking-wider">
            ...
            {/* Progress Bar */}
            <div className="w-full bg-[#F5F0E8] h-1.5 overflow-hidden border-b border-[#FAF7F2]">
                <div
            ...
            <div className="p-5 flex flex-col flex-1 bg-white justify-between gap-4">
                <div>
                    ...
                    {/* Next Lesson Tile */}
                    <div className="mt-3 bg-[#FAF7F2] rounded-lg p-3 flex items-center gap-3 border border-[#FAF7F2] group-hover/card:border-[#B8B0A3] transition-all duration-200">
