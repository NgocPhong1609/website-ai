            ...
            <div className="bg-white w-full max-w-4xl rounded-3xl p-8 shadow-2xl border border-gray-100 flex flex-col gap-6 relative my-8 animate-in fade-in zoom-in-95 duration-200">
                ...
                {loading || !details ? (
                    <div className="py-20 flex flex-col items-center justify-center gap-3">
                        <div className="w-10 h-10 border-4 border-[#FAF7F2] border-t-transparent rounded-full animate-spin" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-start">
                            ...
                            <div>
                                ...
                                <ul className="flex flex-col gap-2">
                                    {details.key_takeaways?.map((point: string, idx: number) => (
                                        <li key={idx} className="text-xs text-[#8A8478] flex items-start gap-2.5 bg-[#F5F0E8] p-2.5 rounded-xl border border-[#FAF7F2]">
                        ...
                        <div className="md:col-span-5 flex flex-col gap-3 max-h-[420px] overflow-y-auto pr-1">
                            ...
                            {details.recommended_courses?.map((course, idx) => (
                                <div key={idx} className="bg-white border border-[#FAF7F2] rounded-2xl p-4 flex flex-col gap-2.5 hover:shadow-md transition-all hover:border-[#B8B0A3]">
