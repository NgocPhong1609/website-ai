...
function StepBadge() {
    return (
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#C0392B] border border-[#FAF7F2] backdrop-blur-sm">
...
function CelebrationBanner({ goal }: { goal: string }) {
    return (
        <div className="relative w-full max-w-4xl bg-[#C0392B] via-[#818cf8]/6 border border-[#FAF7F2] rounded-2xl px-6 py-4 overflow-hidden">
            ...
            <div className="flex flex-col items-center gap-3">
                <div className="flex items-center gap-3">
                    <Button
                        ...
                        size="unstyled"
                        variant="unstyled"
                        className="px-6 py-4 rounded-2xl text-sm font-semibold text-[#8A8478] border border-[#E2E2EA] bg-white hover:border-[#FAF7F2] hover:text-[#C0392B] transition-all duration-200 cursor-pointer"
                    >
                        ← Back
                    </Button>
