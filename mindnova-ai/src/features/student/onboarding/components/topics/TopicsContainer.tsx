...
function StepBadge() {
    return (
        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#FAF7F2] border border-[#FAF7F2]">
            <SparkleIcon />
                        ...
                        {timeOptions.map((time) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`px-4 py-3.5 flex items-center justify-between gap-2 rounded-xl text-sm font-semibold transition-all border ${isSelected
                                        ? "bg-[#FAF7F2] text-[#C0392B] border-[#FAF7F2] shadow-sm"
