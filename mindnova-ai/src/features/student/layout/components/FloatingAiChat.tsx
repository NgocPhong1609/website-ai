  ...
  return (
    ...
    >
      ...
      >
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <div className="flex items-center gap-1.5">
                  <h3 className="text-xs font-bold text-[#2C3039] tracking-tight">
                    Nova AI Co-Pilot
                  </h3>
            ...
            {messages.map((msg) => (
              ...
              >
                ...
                <div className={`flex flex-col gap-1 ${msg.sender === "user" ? "items-end" : ""}`}>
                  ...
                  <span className="text-[10px] font-normal text-[#8A8478] px-1">{msg.time}</span>
                </div>
              </div>
            ))}
          ...
          {/* Footer Input Bar */}
          <div role="group" aria-label="Khung nhập tin nhắn AI" className="p-2.5 bg-white border-t border-[#E8E9F2] shrink-0">
            <form
              onSubmit={(e) => {
                e.preventDefault();
            ...
            {quota && (
              <span aria-label="Hạn mức AI hôm nay" className="mt-1.5 block text-center text-[11px] text-[#8A8478]">
