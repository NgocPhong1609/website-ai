...
export function AdminAnalyticsPage() {
 ...
 <h1 className="mt-1 text-2xl font-semibold [font-family:var(--font-sans)]">Báo cáo tài chính, học tập và hệ thống</h1>
 </div>
 ...
 <div>
 <h2 className="text-lg font-semibold text-slate-900 [font-family:var(--font-sans)]">Lưu lượng truy cập</h2>
 ...
 <div className="rounded-2xl border-[#E2E8F0]/80 bg-white/95 p-4">
 <h2 className="mb-3 text-lg font-semibold text-slate-900 [font-family:var(--font-sans)]">Hiệu suất học tập tổng quan</h2>
 ...
 <div className="flex flex-wrap items-center justify-between gap-3">
 <div>
 <h2 className="text-lg font-semibold text-slate-900 [font-family:var(--font-sans)]">Doanh thu theo khóa học</h2>
