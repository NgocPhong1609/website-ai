...
export function AdminQuickActions({ quickActions }: AdminQuickActionsProps) {
 ...
 <h2 className="text-lg font-semibold text-slate-900 [font-family:var(--font-sans)]">Tác vụ nhanh</h2>
 ...
 className="rounded-xl border border-slate-200 from-slate-50 to-white px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:border-[#2563EB] hover:bg-blue-50/80 hover:text-[#2563EB]"
 >
 {action}
 </button>
 ))}
