...
export function AdminQuickActions({ quickActions }: AdminQuickActionsProps) {
 ...
 className="rounded-xl border border-slate-200 from-slate-50 to-white px-4 py-3 text-left text-sm font-medium text-slate-700 transition hover:-[#C0392B] hover:bg-cyan-50/80 hover:-[#C0392B]"
 >
 {action}
 </button>
 ))}
