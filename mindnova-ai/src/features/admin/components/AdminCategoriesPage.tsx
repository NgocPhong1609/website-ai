...
export async function AdminCategoriesPage() {
 ...
 <section className="mn-stagger rounded-2xl border-[#E2E8F0]/20 bg-[linear-gradient(125deg,#10223f_0%,#0f3f5f_50%,#2563EB_100%)] py-3.5 px-5 text-white shadow-[0_20px_50px_-25px_rgba(13,23,56,0.95)]">
 <div>
 <p className="text-[10px] uppercase tracking-[0.35em] text-[#F8FAFC]/70">Danh mục khóa học</p>
 <h1 className="mt-1 text-2xl font-semibold [font-family:var(--font-sans)]">Kiểm duyệt danh mục khóa học</h1>
 ...
 <div className="mb-4">
 <h2 className="text-lg font-semibold text-slate-900 [font-family:var(--font-sans)]">Danh sách danh mục</h2>
 </div>
