...
export async function AdminCouponsPage() {
 ...
 <section className="mn-stagger rounded-2xl border -[#FAF7F2]/20 bg-[linear-gradient(125deg,#0f1a3c_0%,#183067_45%,#0f766e_100%)] py-3.5 px-5 text-white shadow-[0_20px_50px_-25px_rgba(13,23,56,0.95)]">
 <div>
 <p className="text-[10px] uppercase tracking-[0.35em] -[#FAF7F2]/70">Mã giảm giá</p>
 ...
 <span className="rounded-full bg-emerald-50 px-3 py-1 text-xs font-semibold -[#2C3039] ring-1 ring-emerald-100">{data.rows.length} mã</span>
 </div>
 ...
 <span className={`rounded-full px-2.5 py-1 text-xs font-semibold ${row.isActive ? "-[#FAF7F2] -[#2C3039]" : "bg-slate-100 text-slate-700"}`}>
