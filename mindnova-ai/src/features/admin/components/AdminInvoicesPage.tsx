...
export async function AdminInvoicesPage({ filters }: AdminInvoicesPageProps) {
 ...
 <h1 className="mt-1 text-2xl font-semibold [font-family:var(--font-sans)]">Danh sách hóa đơn</h1>
 ...
 <h2 className="text-lg font-semibold text-slate-900 [font-family:var(--font-sans)]">Hóa đơn gần đây</h2>
