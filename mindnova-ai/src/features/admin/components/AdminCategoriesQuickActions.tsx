...
function statusPillClass(status: string): string {
  ...
  if (value.includes("active")) return "bg-emerald-100 text-emerald-700";
...
export function AdminCategoriesQuickActions({ rows }: AdminCategoriesQuickActionsProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      {editingCategory && (
        <form onSubmit={handleUpdate} className="rounded-2xl border border-cyan-200 bg-cyan-50/60 p-4 shadow-sm">
