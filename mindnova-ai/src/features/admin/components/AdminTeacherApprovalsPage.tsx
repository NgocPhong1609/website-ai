...
export async function AdminTeacherApprovalsPage() {
 ...
 <p className="text-[10px] uppercase tracking-[0.35em] text-[#F8FAFC]/65">Teacher Verification & Blue Tick Badge</p>
 <h1 className="mt-1 text-2xl font-semibold [font-family:var(--font-sans)]">Duyệt xác minh giáo viên</h1>
