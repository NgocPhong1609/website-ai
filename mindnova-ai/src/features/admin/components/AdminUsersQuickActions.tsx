...
export function AdminUsersQuickActions() {
 ...
 className="rounded-2xl -[#C0392B] px-4 py-2 text-sm font-semibold text-slate-950 transition hover:-[#C0392B]"
 >
 + Thêm người dùng
 </button>
 ...
 className="mt-4 w-full rounded-[24px] border -[#FAF7F2] bg-white p-5 shadow-[0_18px_45px_-25px_rgba(8,145,178,0.55)]"
 >
 ...
 autoComplete="name"
 required
 className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm outline-none ring-0 transition focus:-[#C0392B]"
 />
