    ...
    <div className="w-145 flex flex-col items-start gap-4.5">
      ...
      <div className="mt-5 max-w-112.25 w-full flex gap-3">
        <Button
          ...
          className="max-w-60.5 w-full py-4 rounded-xl text-[20px] font-semibold bg-linear-brand cursor-pointer"
        >
          Get Started
        </Button>
        <Button
          onClick={onExplore}
          className="max-w-47.75 w-full rounded-xl bg-white cursor-pointer"
        >
