...
> = {
  ready: {
    dotClass: "bg-[#4648D4]",
    labelClass: "text-[#4648D4] font-semibold",
    label: "Ready",
  },
  upcoming: {
    dotClass: "bg-[#00A896]",
    labelClass: "text-[#00A896] font-semibold",
    label: "Up Next",
  },
  locked: {
    dotClass: "bg-[#C7C4D7]",
    labelClass: "text-[#ADADC0]",
    label: "Locked",
  },
};
      ...
      <div className="flex-1 flex items-center justify-between py-2">
        <span
          className={twMerge(
            ...
            item.status === "locked"
              ? "text-[#ADADC0]"
              : "text-[#464554] font-medium",
          )}
        >
          {item.label}
        </span>
        <span className={twMerge("text-[10px] shrink-0 ml-2", cfg.labelClass)}>
